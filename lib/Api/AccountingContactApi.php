...
class AccountingContactApi
{
     ...
     * @return \Itsmind\Sevdesk\Model\ModelAccountingContactResponse
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ModelAccountingContactResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAccountingContactWithHttpInfo($model_accounting_contact = null, string $contentType = self::contentTypes['createAccountingContact'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\ModelAccountingContactResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ModelAccountingContactResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ModelAccountingContactResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Itsmind\Sevdesk\Model\ModelAccountingContactResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\ModelAccountingContactResponse',
     ...
     * @param  bool $count_all If all accounting contacts should be counted (optional)
     * @param  int $limit The max number of accounting contacts (optional)
     ...
     */
    public function getAccountingContact($contact_id = null, $contact_object_name = 'Contact', $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getAccountingContact'][0])
    {
        list($response) = $this->getAccountingContactWithHttpInfo($contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getAccountingContactWithHttpInfo($contact_id = null, $contact_object_name = 'Contact', $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getAccountingContact'][0])
    {
        $request = $this->getAccountingContactRequest($contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountingContactAsync($contact_id = null, $contact_object_name = 'Contact', $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getAccountingContact'][0])
    {
        return $this->getAccountingContactAsyncWithHttpInfo($contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountingContactAsyncWithHttpInfo($contact_id = null, $contact_object_name = 'Contact', $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getAccountingContact'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetAccountingContact200Response';
        $request = $this->getAccountingContactRequest($contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAccountingContactRequest($contact_id = null, $contact_object_name = 'Contact', $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getAccountingContact'][0])
    {
