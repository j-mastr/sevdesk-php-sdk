...
class AccountingContactApi
{
     ...
     *
     * @param  \Itsmind\Sevdesk\Model\ModelAccountingContact|null $model_accounting_contact Creation data (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\CreateAccountingContact201Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\CreateAccountingContact201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAccountingContactWithHttpInfo($model_accounting_contact = null, string $contentType = self::contentTypes['createAccountingContact'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\CreateAccountingContact201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\CreateAccountingContact201Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\CreateAccountingContact201Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\CreateAccountingContact201Response';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\CreateAccountingContact201Response',
     ...
     *
     * @param  string|null $contact_id ID of contact for which you want the accounting contact. (optional)
     * @param  string|null $contact_object_name Object name. Only needed if you also defined the ID of a contact. (optional, default to 'Contact')
     ...
     */
    public function getAccountingContact($contact_id = null, $contact_object_name = 'Contact', $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getAccountingContact'][0])
    {
        list($response) = $this->getAccountingContactWithHttpInfo($contact_id, $contact_object_name, $count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getAccountingContactWithHttpInfo($contact_id = null, $contact_object_name = 'Contact', $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getAccountingContact'][0])
    {
        $request = $this->getAccountingContactRequest($contact_id, $contact_object_name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountingContactAsync($contact_id = null, $contact_object_name = 'Contact', $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getAccountingContact'][0])
    {
        return $this->getAccountingContactAsyncWithHttpInfo($contact_id, $contact_object_name, $count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountingContactAsyncWithHttpInfo($contact_id = null, $contact_object_name = 'Contact', $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getAccountingContact'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetAccountingContact200Response';
        $request = $this->getAccountingContactRequest($contact_id, $contact_object_name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAccountingContactRequest($contact_id = null, $contact_object_name = 'Contact', $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getAccountingContact'][0])
    {
     ...
     * @param  \Itsmind\Sevdesk\Model\ModelAccountingContactUpdate|null $model_accounting_contact_update Update data (optional)
