...
class BasicsApi
{
    ...
    /**
     * Operation bookkeepingSystemVersion
     *
     * Retrieve bookkeeping system version
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bookkeepingSystemVersion'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\BookkeepingSystemVersion200Response
     */
    public function bookkeepingSystemVersion(string $contentType = self::contentTypes['bookkeepingSystemVersion'][0])
    {
        list($response) = $this->bookkeepingSystemVersionWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation bookkeepingSystemVersionWithHttpInfo
     *
     * Retrieve bookkeeping system version
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bookkeepingSystemVersion'] to see the possible values for this operation
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\BookkeepingSystemVersion200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function bookkeepingSystemVersionWithHttpInfo(string $contentType = self::contentTypes['bookkeepingSystemVersion'][0])
    {
        $request = $this->bookkeepingSystemVersionRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\BookkeepingSystemVersion200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\BookkeepingSystemVersion200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\BookkeepingSystemVersion200Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\BookkeepingSystemVersion200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\BookkeepingSystemVersion200Response',
    ...
    /**
     * Operation bookkeepingSystemVersionAsync
     *
     * Retrieve bookkeeping system version
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bookkeepingSystemVersion'] to see the possible values for this operation
     ...
     */
    public function bookkeepingSystemVersionAsync(string $contentType = self::contentTypes['bookkeepingSystemVersion'][0])
    {
        return $this->bookkeepingSystemVersionAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bookkeepingSystemVersionAsyncWithHttpInfo
     *
     * Retrieve bookkeeping system version
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bookkeepingSystemVersion'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bookkeepingSystemVersionAsyncWithHttpInfo(string $contentType = self::contentTypes['bookkeepingSystemVersion'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\BookkeepingSystemVersion200Response';
        $request = $this->bookkeepingSystemVersionRequest($contentType);
    ...
    /**
     * Create request for operation 'bookkeepingSystemVersion'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bookkeepingSystemVersion'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function bookkeepingSystemVersionRequest(string $contentType = self::contentTypes['bookkeepingSystemVersion'][0])
    {


        $resourcePath = '/Tools/bookkeepingSystemVersion';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
