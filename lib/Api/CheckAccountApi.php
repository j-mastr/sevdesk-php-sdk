...
class CheckAccountApi
{
    ...
    /**
     * Operation createClearingAccount
     *
     * Create a new clearing account
     *
     * @param  \Itsmind\Sevdesk\Model\CreateClearingAccount|null $create_clearing_account Data to create a clearning account (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createClearingAccount'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\CreateClearingAccount201Response
     */
    public function createClearingAccount($create_clearing_account = null, string $contentType = self::contentTypes['createClearingAccount'][0])
    {
        list($response) = $this->createClearingAccountWithHttpInfo($create_clearing_account, $contentType);
        return $response;
    }

    /**
     * Operation createClearingAccountWithHttpInfo
     *
     * Create a new clearing account
     *
     * @param  \Itsmind\Sevdesk\Model\CreateClearingAccount|null $create_clearing_account Data to create a clearning account (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\CreateClearingAccount201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createClearingAccountWithHttpInfo($create_clearing_account = null, string $contentType = self::contentTypes['createClearingAccount'][0])
    {
        $request = $this->createClearingAccountRequest($create_clearing_account, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\CreateClearingAccount201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\CreateClearingAccount201Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\CreateClearingAccount201Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\CreateClearingAccount201Response';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\CreateClearingAccount201Response',
    ...
    /**
     * Operation createClearingAccountAsync
     *
     * Create a new clearing account
     *
     * @param  \Itsmind\Sevdesk\Model\CreateClearingAccount|null $create_clearing_account Data to create a clearning account (optional)
     ...
     */
    public function createClearingAccountAsync($create_clearing_account = null, string $contentType = self::contentTypes['createClearingAccount'][0])
    {
        return $this->createClearingAccountAsyncWithHttpInfo($create_clearing_account, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createClearingAccountAsyncWithHttpInfo
     *
     * Create a new clearing account
     *
     * @param  \Itsmind\Sevdesk\Model\CreateClearingAccount|null $create_clearing_account Data to create a clearning account (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createClearingAccountAsyncWithHttpInfo($create_clearing_account = null, string $contentType = self::contentTypes['createClearingAccount'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\CreateClearingAccount201Response';
        $request = $this->createClearingAccountRequest($create_clearing_account, $contentType);
    ...
    /**
     * Create request for operation 'createClearingAccount'
     *
     * @param  \Itsmind\Sevdesk\Model\CreateClearingAccount|null $create_clearing_account Data to create a clearning account (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createClearingAccount'] to see the possible values for this operation
     *
     ...
     */
    public function createClearingAccountRequest($create_clearing_account = null, string $contentType = self::contentTypes['createClearingAccount'][0])
    {



        $resourcePath = '/CheckAccount/Factory/clearingAccount';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($create_clearing_account)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_clearing_account));
            } else {
                $httpBody = $create_clearing_account;
            }
     ...
     *
     * @param  \Itsmind\Sevdesk\Model\CreateFileImportAccount|null $create_file_import_account Data to create a file import account (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFileImportAccount'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\CreateFileImportAccount201Response
     */
    public function createFileImportAccount($create_file_import_account = null, string $contentType = self::contentTypes['createFileImportAccount'][0])
    {
        list($response) = $this->createFileImportAccountWithHttpInfo($create_file_import_account, $contentType);
        return $response;
    }

    /**
     * Operation createFileImportAccountWithHttpInfo
     *
     * Create a new file import account
     *
     * @param  \Itsmind\Sevdesk\Model\CreateFileImportAccount|null $create_file_import_account Data to create a file import account (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\CreateFileImportAccount201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createFileImportAccountWithHttpInfo($create_file_import_account = null, string $contentType = self::contentTypes['createFileImportAccount'][0])
    {
        $request = $this->createFileImportAccountRequest($create_file_import_account, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\CreateFileImportAccount201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\CreateFileImportAccount201Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\CreateFileImportAccount201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\CreateFileImportAccount201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\CreateFileImportAccount201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation createFileImportAccountAsync
     *
     * Create a new file import account
     *
     * @param  \Itsmind\Sevdesk\Model\CreateFileImportAccount|null $create_file_import_account Data to create a file import account (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createFileImportAccountAsync($create_file_import_account = null, string $contentType = self::contentTypes['createFileImportAccount'][0])
    {
        return $this->createFileImportAccountAsyncWithHttpInfo($create_file_import_account, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createFileImportAccountAsyncWithHttpInfo
     *
     * Create a new file import account
     *
     * @param  \Itsmind\Sevdesk\Model\CreateFileImportAccount|null $create_file_import_account Data to create a file import account (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createFileImportAccountAsyncWithHttpInfo($create_file_import_account = null, string $contentType = self::contentTypes['createFileImportAccount'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\CreateFileImportAccount201Response';
        $request = $this->createFileImportAccountRequest($create_file_import_account, $contentType);
    ...
    /**
     * Create request for operation 'createFileImportAccount'
     *
     * @param  \Itsmind\Sevdesk\Model\CreateFileImportAccount|null $create_file_import_account Data to create a file import account (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFileImportAccount'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createFileImportAccountRequest($create_file_import_account = null, string $contentType = self::contentTypes['createFileImportAccount'][0])
    {



        $resourcePath = '/CheckAccount/Factory/fileImportAccount';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($create_file_import_account)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_file_import_account));
            } else {
                $httpBody = $create_file_import_account;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\GetCheckAccounts200Response
     */
    public function getCheckAccounts($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCheckAccounts'][0])
    {
        list($response) = $this->getCheckAccountsWithHttpInfo($count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\GetCheckAccounts200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCheckAccountsWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCheckAccounts'][0])
    {
        $request = $this->getCheckAccountsRequest($count_all, $offset, $limit, $embed, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\GetCheckAccounts200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\GetCheckAccounts200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\GetCheckAccounts200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\GetCheckAccounts200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\GetCheckAccounts200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCheckAccountsAsync($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCheckAccounts'][0])
    {
        return $this->getCheckAccountsAsyncWithHttpInfo($count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCheckAccountsAsyncWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCheckAccounts'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetCheckAccounts200Response';
        $request = $this->getCheckAccountsRequest($count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCheckAccountsRequest($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCheckAccounts'][0])
    {
     ...
     * @param  \Itsmind\Sevdesk\Model\ModelCheckAccountUpdate|null $model_check_account_update Update data (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\UpdateCheckAccount200Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\UpdateCheckAccount200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCheckAccountWithHttpInfo($check_account_id, $model_check_account_update = null, string $contentType = self::contentTypes['updateCheckAccount'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\UpdateCheckAccount200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\UpdateCheckAccount200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\UpdateCheckAccount200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\UpdateCheckAccount200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\UpdateCheckAccount200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
