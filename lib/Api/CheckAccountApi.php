...
class CheckAccountApi
{
     ...
     * @return \Itsmind\Sevdesk\Model\GetCheckAccounts200Response
     */
    public function getCheckAccounts($embed = null, string $contentType = self::contentTypes['getCheckAccounts'][0])
    {
        list($response) = $this->getCheckAccountsWithHttpInfo($embed, $contentType);
        return $response;
    }
     ...
     * @return array of \Itsmind\Sevdesk\Model\GetCheckAccounts200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCheckAccountsWithHttpInfo($embed = null, string $contentType = self::contentTypes['getCheckAccounts'][0])
    {
        $request = $this->getCheckAccountsRequest($embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCheckAccountsAsync($embed = null, string $contentType = self::contentTypes['getCheckAccounts'][0])
    {
        return $this->getCheckAccountsAsyncWithHttpInfo($embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCheckAccountsAsyncWithHttpInfo($embed = null, string $contentType = self::contentTypes['getCheckAccounts'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetCheckAccounts200Response';
        $request = $this->getCheckAccountsRequest($embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCheckAccountsRequest($embed = null, string $contentType = self::contentTypes['getCheckAccounts'][0])
    {
