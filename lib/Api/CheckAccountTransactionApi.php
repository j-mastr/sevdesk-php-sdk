...
class CheckAccountTransactionApi
{
     ...
     */
    public function getTransactions($check_account_id = null, $check_account_object_name = null, $is_booked = null, $paymt_purpose = null, $start_date = null, $end_date = null, $payee_payer_name = null, $only_credit = null, $only_debit = null, $count_all = null, $limit = null, $offset = null, $status = null, $hide_fees = null, $search_for_invoice_and_voucher = null, string $contentType = self::contentTypes['getTransactions'][0])
    {
        list($response) = $this->getTransactionsWithHttpInfo($check_account_id, $check_account_object_name, $is_booked, $paymt_purpose, $start_date, $end_date, $payee_payer_name, $only_credit, $only_debit, $count_all, $limit, $offset, $status, $hide_fees, $search_for_invoice_and_voucher, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getTransactionsRequest($check_account_id, $check_account_object_name, $is_booked, $paymt_purpose, $start_date, $end_date, $payee_payer_name, $only_credit, $only_debit, $count_all, $limit, $offset, $status, $hide_fees, $search_for_invoice_and_voucher, $contentType);
    ...
    {
        return $this->getTransactionsAsyncWithHttpInfo($check_account_id, $check_account_object_name, $is_booked, $paymt_purpose, $start_date, $end_date, $payee_payer_name, $only_credit, $only_debit, $count_all, $limit, $offset, $status, $hide_fees, $search_for_invoice_and_voucher, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
