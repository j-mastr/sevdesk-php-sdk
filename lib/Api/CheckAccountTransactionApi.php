...
class CheckAccountTransactionApi
{
    ...
    /**
     * Operation checkAccountTransactionEnshrine
     *
     * Enshrine
     *
     * @param  int $check_account_transaction_id ID of the transaction to enshrine (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['checkAccountTransactionEnshrine'] to see the possible values for this operation
     *
     ...
     */
    public function checkAccountTransactionEnshrine($check_account_transaction_id, string $contentType = self::contentTypes['checkAccountTransactionEnshrine'][0])
    {
        list($response) = $this->checkAccountTransactionEnshrineWithHttpInfo($check_account_transaction_id, $contentType);
        return $response;
    }

    /**
     * Operation checkAccountTransactionEnshrineWithHttpInfo
     *
     * Enshrine
     *
     * @param  int $check_account_transaction_id ID of the transaction to enshrine (required)
     ...
     */
    public function checkAccountTransactionEnshrineWithHttpInfo($check_account_transaction_id, string $contentType = self::contentTypes['checkAccountTransactionEnshrine'][0])
    {
        $request = $this->checkAccountTransactionEnshrineRequest($check_account_transaction_id, $contentType);
    ...
    /**
     * Operation checkAccountTransactionEnshrineAsync
     *
     * Enshrine
     *
     * @param  int $check_account_transaction_id ID of the transaction to enshrine (required)
     ...
     */
    public function checkAccountTransactionEnshrineAsync($check_account_transaction_id, string $contentType = self::contentTypes['checkAccountTransactionEnshrine'][0])
    {
        return $this->checkAccountTransactionEnshrineAsyncWithHttpInfo($check_account_transaction_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation checkAccountTransactionEnshrineAsyncWithHttpInfo
     *
     * Enshrine
     *
     * @param  int $check_account_transaction_id ID of the transaction to enshrine (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkAccountTransactionEnshrineAsyncWithHttpInfo($check_account_transaction_id, string $contentType = self::contentTypes['checkAccountTransactionEnshrine'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\CheckAccountTransactionEnshrine200Response';
        $request = $this->checkAccountTransactionEnshrineRequest($check_account_transaction_id, $contentType);
    ...
    /**
     * Create request for operation 'checkAccountTransactionEnshrine'
     *
     * @param  int $check_account_transaction_id ID of the transaction to enshrine (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['checkAccountTransactionEnshrine'] to see the possible values for this operation
     *
     ...
     */
    public function checkAccountTransactionEnshrineRequest($check_account_transaction_id, string $contentType = self::contentTypes['checkAccountTransactionEnshrine'][0])
    {
        ...
        if ($check_account_transaction_id === null || (is_array($check_account_transaction_id) && count($check_account_transaction_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $check_account_transaction_id when calling checkAccountTransactionEnshrine'
            );
        }


        $resourcePath = '/CheckAccountTransaction/{checkAccountTransactionId}/enshrine';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\CreateTransaction201Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\CreateTransaction201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTransactionWithHttpInfo($model_check_account_transaction = null, string $contentType = self::contentTypes['createTransaction'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\CreateTransaction201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\CreateTransaction201Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\CreateTransaction201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\CreateTransaction201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\CreateTransaction201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int|null $check_account_id Retrieve all transactions on this check account. Must be provided with checkAccount[objectName] (optional)
     * @param  string|null $check_account_object_name Only required if checkAccount[id] was provided. &#39;CheckAccount&#39; should be used as value. (optional)
     * @param  bool|null $is_booked Only retrieve booked transactions (optional)
     * @param  string|null $paymt_purpose Only retrieve transactions with this payment purpose (optional)
     * @param  \DateTime|null $start_date Only retrieve transactions from this date on (optional)
     * @param  \DateTime|null $end_date Only retrieve transactions up to this date (optional)
     * @param  string|null $payee_payer_name Only retrieve transactions with this payee / payer (optional)
     * @param  bool|null $only_credit Only retrieve credit transactions (optional)
     * @param  bool|null $only_debit Only retrieve debit transactions (optional)
     * @param  bool|null $count_all If all transactions should be counted (optional)
     * @param  int|null $limit The max number of transactions (optional)
     * @param  int|null $offset Which offset to start with (optional)
     * @param  float|null $status Status of the transaction (optional)
     * @param  bool|null $hide_fees Do not include fees for financial transactions (optional)
     * @param  string|null $search_for_invoice_and_voucher Search for transactions linked with a given invoice or voucher (optional)
     ...
     */
    public function getTransactions($check_account_id = null, $check_account_object_name = null, $is_booked = null, $paymt_purpose = null, $start_date = null, $end_date = null, $payee_payer_name = null, $only_credit = null, $only_debit = null, $count_all = null, $limit = null, $offset = null, $status = null, $hide_fees = null, $search_for_invoice_and_voucher = null, $embed = null, string $contentType = self::contentTypes['getTransactions'][0])
    {
        list($response) = $this->getTransactionsWithHttpInfo($check_account_id, $check_account_object_name, $is_booked, $paymt_purpose, $start_date, $end_date, $payee_payer_name, $only_credit, $only_debit, $count_all, $limit, $offset, $status, $hide_fees, $search_for_invoice_and_voucher, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getTransactionsWithHttpInfo($check_account_id = null, $check_account_object_name = null, $is_booked = null, $paymt_purpose = null, $start_date = null, $end_date = null, $payee_payer_name = null, $only_credit = null, $only_debit = null, $count_all = null, $limit = null, $offset = null, $status = null, $hide_fees = null, $search_for_invoice_and_voucher = null, $embed = null, string $contentType = self::contentTypes['getTransactions'][0])
    {
        $request = $this->getTransactionsRequest($check_account_id, $check_account_object_name, $is_booked, $paymt_purpose, $start_date, $end_date, $payee_payer_name, $only_credit, $only_debit, $count_all, $limit, $offset, $status, $hide_fees, $search_for_invoice_and_voucher, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTransactionsAsync($check_account_id = null, $check_account_object_name = null, $is_booked = null, $paymt_purpose = null, $start_date = null, $end_date = null, $payee_payer_name = null, $only_credit = null, $only_debit = null, $count_all = null, $limit = null, $offset = null, $status = null, $hide_fees = null, $search_for_invoice_and_voucher = null, $embed = null, string $contentType = self::contentTypes['getTransactions'][0])
    {
        return $this->getTransactionsAsyncWithHttpInfo($check_account_id, $check_account_object_name, $is_booked, $paymt_purpose, $start_date, $end_date, $payee_payer_name, $only_credit, $only_debit, $count_all, $limit, $offset, $status, $hide_fees, $search_for_invoice_and_voucher, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTransactionsAsyncWithHttpInfo($check_account_id = null, $check_account_object_name = null, $is_booked = null, $paymt_purpose = null, $start_date = null, $end_date = null, $payee_payer_name = null, $only_credit = null, $only_debit = null, $count_all = null, $limit = null, $offset = null, $status = null, $hide_fees = null, $search_for_invoice_and_voucher = null, $embed = null, string $contentType = self::contentTypes['getTransactions'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetTransactions200Response';
        $request = $this->getTransactionsRequest($check_account_id, $check_account_object_name, $is_booked, $paymt_purpose, $start_date, $end_date, $payee_payer_name, $only_credit, $only_debit, $count_all, $limit, $offset, $status, $hide_fees, $search_for_invoice_and_voucher, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTransactionsRequest($check_account_id = null, $check_account_object_name = null, $is_booked = null, $paymt_purpose = null, $start_date = null, $end_date = null, $payee_payer_name = null, $only_credit = null, $only_debit = null, $count_all = null, $limit = null, $offset = null, $status = null, $hide_fees = null, $search_for_invoice_and_voucher = null, $embed = null, string $contentType = self::contentTypes['getTransactions'][0])
    {
     ...
     * @param  \Itsmind\Sevdesk\Model\ModelCheckAccountTransactionUpdate|null $model_check_account_transaction_update Update data (optional)
