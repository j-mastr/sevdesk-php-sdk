...
class CommunicationWayApi
{
     ...
     *
     * @param  \Itsmind\Sevdesk\Model\ModelCommunicationWay|null $model_communication_way Creation data (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\CreateCommunicationWay201Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\CreateCommunicationWay201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCommunicationWayWithHttpInfo($model_communication_way = null, string $contentType = self::contentTypes['createCommunicationWay'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\CreateCommunicationWay201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\CreateCommunicationWay201Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\CreateCommunicationWay201Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\CreateCommunicationWay201Response';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\CreateCommunicationWay201Response',
     ...
     */
    public function getCommunicationWayById($communication_way_id, $embed = null, string $contentType = self::contentTypes['getCommunicationWayById'][0])
    {
        list($response) = $this->getCommunicationWayByIdWithHttpInfo($communication_way_id, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getCommunicationWayByIdWithHttpInfo($communication_way_id, $embed = null, string $contentType = self::contentTypes['getCommunicationWayById'][0])
    {
        $request = $this->getCommunicationWayByIdRequest($communication_way_id, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWayByIdAsync($communication_way_id, $embed = null, string $contentType = self::contentTypes['getCommunicationWayById'][0])
    {
        return $this->getCommunicationWayByIdAsyncWithHttpInfo($communication_way_id, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWayByIdAsyncWithHttpInfo($communication_way_id, $embed = null, string $contentType = self::contentTypes['getCommunicationWayById'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetCommunicationWayById200Response';
        $request = $this->getCommunicationWayByIdRequest($communication_way_id, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCommunicationWayByIdRequest($communication_way_id, $embed = null, string $contentType = self::contentTypes['getCommunicationWayById'][0])
    {
     ...
     */
    public function getCommunicationWayKeys($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWayKeys'][0])
    {
        list($response) = $this->getCommunicationWayKeysWithHttpInfo($count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getCommunicationWayKeysWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWayKeys'][0])
    {
        $request = $this->getCommunicationWayKeysRequest($count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWayKeysAsync($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWayKeys'][0])
    {
        return $this->getCommunicationWayKeysAsyncWithHttpInfo($count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWayKeysAsyncWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWayKeys'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetCommunicationWayKeys200Response';
        $request = $this->getCommunicationWayKeysRequest($count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCommunicationWayKeysRequest($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWayKeys'][0])
    {
     ...
     *
     * @param  string|null $type Type of the communication ways you want to get. (optional)
     * @param  string|null $main Define if you only want the main communication way. (optional)
     * @param  \Itsmind\Sevdesk\Model\GetCommunicationWaysContactParameter|null $contact Retrieve all communication ways with this contact. The value of contact[objectName] must be &#39;Contact&#39;. (optional)
     * @param  bool|null $count_all If all objects should be counted (optional)
     * @param  int|null $offset Which offset to start with (optional)
     * @param  int|null $limit The max number of objects to return (optional)
     * @param  string[]|null $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     ...
     */
    public function getCommunicationWays($type = null, $main = null, $contact = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
        list($response) = $this->getCommunicationWaysWithHttpInfo($type, $main, $contact, $count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getCommunicationWaysWithHttpInfo($type = null, $main = null, $contact = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
        $request = $this->getCommunicationWaysRequest($type, $main, $contact, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWaysAsync($type = null, $main = null, $contact = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
        return $this->getCommunicationWaysAsyncWithHttpInfo($type, $main, $contact, $count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWaysAsyncWithHttpInfo($type = null, $main = null, $contact = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetCommunicationWays200Response';
        $request = $this->getCommunicationWaysRequest($type, $main, $contact, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCommunicationWaysRequest($type = null, $main = null, $contact = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
     ...
     * @param  \Itsmind\Sevdesk\Model\ModelCommunicationWayUpdate|null $model_communication_way_update Update data (optional)
