...
class CommunicationWayApi
{
     ...
     *
     * @param  bool $count_all If all communication way keys should be counted (optional)
     * @param  int $limit The max number of communication way keys (optional)
     ...
     */
    public function getCommunicationWayKeys($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWayKeys'][0])
    {
        list($response) = $this->getCommunicationWayKeysWithHttpInfo($count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getCommunicationWayKeysWithHttpInfo($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWayKeys'][0])
    {
        $request = $this->getCommunicationWayKeysRequest($count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWayKeysAsync($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWayKeys'][0])
    {
        return $this->getCommunicationWayKeysAsyncWithHttpInfo($count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWayKeysAsyncWithHttpInfo($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWayKeys'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetCommunicationWayKeys200Response';
        $request = $this->getCommunicationWayKeysRequest($count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCommunicationWayKeysRequest($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWayKeys'][0])
    {
     ...
     * @param  bool $count_all If all communication ways should be counted (optional)
     * @param  int $limit The max number of communication ways (optional)
     * @param  int $offset Which offset to start with (optional)
     * @param  string[] $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     ...
     */
    public function getCommunicationWays($contact = null, $type = null, $main = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
        list($response) = $this->getCommunicationWaysWithHttpInfo($contact, $type, $main, $count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getCommunicationWaysWithHttpInfo($contact = null, $type = null, $main = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
        $request = $this->getCommunicationWaysRequest($contact, $type, $main, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWaysAsync($contact = null, $type = null, $main = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
        return $this->getCommunicationWaysAsyncWithHttpInfo($contact, $type, $main, $count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWaysAsyncWithHttpInfo($contact = null, $type = null, $main = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetCommunicationWays200Response';
        $request = $this->getCommunicationWaysRequest($contact, $type, $main, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCommunicationWaysRequest($contact = null, $type = null, $main = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
