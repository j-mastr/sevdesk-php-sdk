...
class CommunicationWayApi
{
     ...
     * @return \Itsmind\Sevdesk\Model\GetCommunicationWays200Response
     */
    public function getCommunicationWays($contact_id = null, $contact_object_name = 'Contact', $type = null, $main = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
     ...
     * @return array of \Itsmind\Sevdesk\Model\GetCommunicationWays200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCommunicationWaysWithHttpInfo($contact_id = null, $contact_object_name = 'Contact', $type = null, $main = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWaysAsync($contact_id = null, $contact_object_name = 'Contact', $type = null, $main = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommunicationWaysAsyncWithHttpInfo($contact_id = null, $contact_object_name = 'Contact', $type = null, $main = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetCommunicationWays200Response';
        $request = $this->getCommunicationWaysRequest($contact_id, $contact_object_name, $type, $main, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCommunicationWaysRequest($contact_id = null, $contact_object_name = 'Contact', $type = null, $main = null, string $contentType = self::contentTypes['getCommunicationWays'][0])
    {
