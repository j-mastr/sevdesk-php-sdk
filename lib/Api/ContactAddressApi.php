...
class ContactAddressApi
{
     ...
     *
     * @param  \Itsmind\Sevdesk\Model\ModelContactAddress|null $model_contact_address Creation data (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\CreateContactAddress201Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\CreateContactAddress201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createContactAddressWithHttpInfo($model_contact_address = null, string $contentType = self::contentTypes['createContactAddress'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\CreateContactAddress201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\CreateContactAddress201Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\CreateContactAddress201Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\CreateContactAddress201Response';
     ...
     */
    public function getContactAddresses($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactAddresses'][0])
    {
        list($response) = $this->getContactAddressesWithHttpInfo($count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getContactAddressesWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactAddresses'][0])
    {
        $request = $this->getContactAddressesRequest($count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactAddressesAsync($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactAddresses'][0])
    {
        return $this->getContactAddressesAsyncWithHttpInfo($count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactAddressesAsyncWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactAddresses'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetContactAddresses200Response';
        $request = $this->getContactAddressesRequest($count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactAddressesRequest($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactAddresses'][0])
    {
     ...
     *
     * @param  int $contact_address_id ID of contact address to return (required)
     * @param  \Itsmind\Sevdesk\Model\ModelContactAddressUpdate|null $model_contact_address_update Creation data (optional)
