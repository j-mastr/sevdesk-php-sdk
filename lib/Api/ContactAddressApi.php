...
class ContactAddressApi
{
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\ModelContactAddressResponse
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ModelContactAddressResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createContactAddressWithHttpInfo($model_contact_address = null, string $contentType = self::contentTypes['createContactAddress'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\ModelContactAddressResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ModelContactAddressResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ModelContactAddressResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Itsmind\Sevdesk\Model\ModelContactAddressResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\ModelContactAddressResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  bool $count_all If all contact addresses should be counted (optional)
     * @param  int $limit The max number of contact addresses (optional)
     ...
     */
    public function getContactAddresses($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactAddresses'][0])
    {
        list($response) = $this->getContactAddressesWithHttpInfo($count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getContactAddressesWithHttpInfo($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactAddresses'][0])
    {
        $request = $this->getContactAddressesRequest($count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactAddressesAsync($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactAddresses'][0])
    {
        return $this->getContactAddressesAsyncWithHttpInfo($count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactAddressesAsyncWithHttpInfo($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactAddresses'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetContactAddresses200Response';
        $request = $this->getContactAddressesRequest($count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactAddressesRequest($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactAddresses'][0])
    {
