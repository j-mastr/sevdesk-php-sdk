...
class ContactApi
{
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ModelContactResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createContactWithHttpInfo($model_contact = null, string $contentType = self::contentTypes['createContact'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\ModelContactResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ModelContactResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ModelContactResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Itsmind\Sevdesk\Model\ModelContactResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  string $custom_field_setting_object_name Object name. Only needed if you also defined the ID of a ContactCustomFieldSetting. (optional, default to 'ContactCustomFieldSetting')
     ...
     */
    public function getContacts($depth = null, $customer_number = null, $count_all = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getContacts'][0])
    {
        list($response) = $this->getContactsWithHttpInfo($depth, $customer_number, $count_all, $limit, $offset, $contentType);
        return $response;
    }
     ...
     */
    public function getContactsWithHttpInfo($depth = null, $customer_number = null, $count_all = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getContacts'][0])
    {
        $request = $this->getContactsRequest($depth, $customer_number, $count_all, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactsAsync($depth = null, $customer_number = null, $count_all = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getContacts'][0])
    {
        return $this->getContactsAsyncWithHttpInfo($depth, $customer_number, $count_all, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactsAsyncWithHttpInfo($depth = null, $customer_number = null, $count_all = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getContacts'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetContacts200Response';
        $request = $this->getContactsRequest($depth, $customer_number, $count_all, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactsRequest($depth = null, $customer_number = null, $count_all = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getContacts'][0])
    {
