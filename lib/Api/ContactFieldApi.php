...
class ContactFieldApi
{
     ...
     *
     * @param  \Itsmind\Sevdesk\Model\ModelContactCustomField|null $model_contact_custom_field model_contact_custom_field (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\CreateContactField200Response
     */
     ...
     * Create contact field
     *
     * @param  \Itsmind\Sevdesk\Model\ModelContactCustomField|null $model_contact_custom_field (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createContactField'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\CreateContactField200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createContactFieldWithHttpInfo($model_contact_custom_field = null, string $contentType = self::contentTypes['createContactField'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\CreateContactField200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\CreateContactField200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\CreateContactField200Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\CreateContactField200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\CreateContactField200Response',
     ...
     *
     * @param  \Itsmind\Sevdesk\Model\ModelContactCustomFieldSetting|null $model_contact_custom_field_setting model_contact_custom_field_setting (optional)
     ...
     * Create contact field setting
     *
     * @param  \Itsmind\Sevdesk\Model\ModelContactCustomFieldSetting|null $model_contact_custom_field_setting (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createContactFieldSetting'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function getContactFieldSettings($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactFieldSettings'][0])
    {
        list($response) = $this->getContactFieldSettingsWithHttpInfo($count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getContactFieldSettingsWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactFieldSettings'][0])
    {
        $request = $this->getContactFieldSettingsRequest($count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactFieldSettingsAsync($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactFieldSettings'][0])
    {
        return $this->getContactFieldSettingsAsyncWithHttpInfo($count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactFieldSettingsAsyncWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactFieldSettings'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetContactFieldSettings200Response';
        $request = $this->getContactFieldSettingsRequest($count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactFieldSettingsRequest($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactFieldSettings'][0])
    {
     ...
     */
    public function getContactFields($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactFields'][0])
    {
        list($response) = $this->getContactFieldsWithHttpInfo($count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getContactFieldsWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactFields'][0])
    {
        $request = $this->getContactFieldsRequest($count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactFieldsAsync($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactFields'][0])
    {
        return $this->getContactFieldsAsyncWithHttpInfo($count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactFieldsAsyncWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactFields'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetContactFields200Response';
        $request = $this->getContactFieldsRequest($count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactFieldsRequest($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getContactFields'][0])
    {
     ...
     * @param  string|null $sub_object_name Sub model name, required if you have \&quot;Email\&quot; at objectName (optional)
     ...
     * @param  \Itsmind\Sevdesk\Model\ModelContactCustomFieldSettingUpdate|null $model_contact_custom_field_setting_update model_contact_custom_field_setting_update (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\UpdateContactFieldSetting200Response
     */
     ...
     *
     * @param  int $contact_custom_field_setting_id ID of contact field setting you want to update (required)
     * @param  \Itsmind\Sevdesk\Model\ModelContactCustomFieldSettingUpdate|null $model_contact_custom_field_setting_update (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateContactFieldSetting'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\UpdateContactFieldSetting200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateContactFieldSettingWithHttpInfo($contact_custom_field_setting_id, $model_contact_custom_field_setting_update = null, string $contentType = self::contentTypes['updateContactFieldSetting'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\UpdateContactFieldSetting200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\UpdateContactFieldSetting200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\UpdateContactFieldSetting200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\UpdateContactFieldSetting200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\UpdateContactFieldSetting200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  float $contact_custom_field_id id of the contact field (required)
     * @param  \Itsmind\Sevdesk\Model\ModelContactCustomFieldUpdate|null $model_contact_custom_field_update Update data (optional)
