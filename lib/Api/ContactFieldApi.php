...
class ContactFieldApi
{
     ...
     * @return \Itsmind\Sevdesk\Model\ModelContactCustomFieldResponse
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ModelContactCustomFieldResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createContactFieldWithHttpInfo($model_contact_custom_field = null, string $contentType = self::contentTypes['createContactField'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\ModelContactCustomFieldResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ModelContactCustomFieldResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ModelContactCustomFieldResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Itsmind\Sevdesk\Model\ModelContactCustomFieldResponse';
     ...
     *
     * @param  bool $count_all If all contact custom field settings should be counted (optional)
     * @param  int $limit The max number of contact custom field settings (optional)
     ...
     */
    public function getContactFieldSettings($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactFieldSettings'][0])
    {
        list($response) = $this->getContactFieldSettingsWithHttpInfo($count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getContactFieldSettingsWithHttpInfo($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactFieldSettings'][0])
    {
        $request = $this->getContactFieldSettingsRequest($count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactFieldSettingsAsync($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactFieldSettings'][0])
    {
        return $this->getContactFieldSettingsAsyncWithHttpInfo($count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactFieldSettingsAsyncWithHttpInfo($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactFieldSettings'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetContactFieldSettings200Response';
        $request = $this->getContactFieldSettingsRequest($count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactFieldSettingsRequest($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactFieldSettings'][0])
    {
     ...
     *
     * @param  bool $count_all If all contact custom fields should be counted (optional)
     * @param  int $limit The max number of contact custom fields (optional)
     * @param  int $offset Which offset to start with (optional)
     * @param  string[] $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     ...
     */
    public function getContactFields($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactFields'][0])
    {
        list($response) = $this->getContactFieldsWithHttpInfo($count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getContactFieldsWithHttpInfo($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactFields'][0])
    {
        $request = $this->getContactFieldsRequest($count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactFieldsAsync($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactFields'][0])
    {
        return $this->getContactFieldsAsyncWithHttpInfo($count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactFieldsAsyncWithHttpInfo($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactFields'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetContactFields200Response';
        $request = $this->getContactFieldsRequest($count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactFieldsRequest($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getContactFields'][0])
    {
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\ModelContactCustomFieldSettingResponse
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ModelContactCustomFieldSettingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateContactFieldSettingWithHttpInfo($contact_custom_field_setting_id, $model_contact_custom_field_setting_update = null, string $contentType = self::contentTypes['updateContactFieldSetting'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\ModelContactCustomFieldSettingResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ModelContactCustomFieldSettingResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ModelContactCustomFieldSettingResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Itsmind\Sevdesk\Model\ModelContactCustomFieldSettingResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
