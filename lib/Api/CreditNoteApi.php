...
class CreditNoteApi
{
     ...
     * @param  \Itsmind\Sevdesk\Model\BookCreditNoteRequest|null $book_credit_note_request Booking data (optional)
     ...
     *
     * @param  \Itsmind\Sevdesk\Model\CreateCreditNoteFromInvoiceRequest|null $create_credit_note_from_invoice_request create_credit_note_from_invoice_request (optional)
     ...
     * Creates a new creditNote from an invoice
     *
     * @param  \Itsmind\Sevdesk\Model\CreateCreditNoteFromInvoiceRequest|null $create_credit_note_from_invoice_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createCreditNoteFromInvoice'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Itsmind\Sevdesk\Model\CreateCreditNoteFromVoucherRequest|null $create_credit_note_from_voucher_request create_credit_note_from_voucher_request (optional)
     ...
     * Creates a new creditNote from a voucher
     *
     * @param  \Itsmind\Sevdesk\Model\CreateCreditNoteFromVoucherRequest|null $create_credit_note_from_voucher_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createCreditNoteFromVoucher'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Itsmind\Sevdesk\Model\SaveCreditNote|null $save_credit_note Creation data. Please be aware, that you need to provide at least all required parameter      of the credit note model! (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\CreatecreditNote201Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\CreatecreditNote201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createcreditNoteWithHttpInfo($save_credit_note = null, string $contentType = self::contentTypes['createcreditNote'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\CreatecreditNote201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\CreatecreditNote201Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\CreatecreditNote201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\CreatecreditNote201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\CreatecreditNote201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  bool|null $download If u want to download the pdf of the credit note. (optional)
     * @param  bool|null $prevent_send_by Defines if u want to send the credit note. (optional)
     ...
     * @param  \Itsmind\Sevdesk\Model\CreditNoteSendByRequest|null $credit_note_send_by_request Specify the send type (optional)
     ...
     * Retrieve CreditNote
     *
     * @param  string|null $status Status of the CreditNote (optional)
     * @param  string|null $credit_note_number Retrieve all CreditNotes with this creditNote number (optional)
     * @param  int|null $start_date Retrieve all CreditNotes with a date equal or higher (optional)
     * @param  int|null $end_date Retrieve all CreditNotes with a date equal or lower (optional)
     * @param  int|null $contact_id Retrieve all CreditNotes with this contact. Must be provided with contact[objectName] (optional)
     ...
     * @param  \Itsmind\Sevdesk\Model\SendCreditNoteViaEMailRequest|null $send_credit_note_via_e_mail_request Mail data (optional)
     ...
     * @param  \Itsmind\Sevdesk\Model\ModelCreditNoteUpdate|null $model_credit_note_update Update data (optional)
