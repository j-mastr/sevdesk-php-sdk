...
class CreditNoteApi
{
     ...
     * @param  bool $count_all If all credit notes should be counted (optional)
     * @param  int $limit The max number of credit notes (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\GetCreditNotes200Response
     */
    public function getCreditNotes($status = null, $credit_note_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCreditNotes'][0])
    {
        list($response) = $this->getCreditNotesWithHttpInfo($status, $credit_note_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     * @return array of \Itsmind\Sevdesk\Model\GetCreditNotes200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCreditNotesWithHttpInfo($status = null, $credit_note_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCreditNotes'][0])
    {
        $request = $this->getCreditNotesRequest($status, $credit_note_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCreditNotesAsync($status = null, $credit_note_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCreditNotes'][0])
    {
        return $this->getCreditNotesAsyncWithHttpInfo($status, $credit_note_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCreditNotesAsyncWithHttpInfo($status = null, $credit_note_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCreditNotes'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetCreditNotes200Response';
        $request = $this->getCreditNotesRequest($status, $credit_note_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCreditNotesRequest($status = null, $credit_note_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getCreditNotes'][0])
    {
