...
class CreditNotePosApi
{
     ...
     * @param  bool $count_all If all credit note pos should be counted (optional)
     * @param  int $limit The max number of credit note pos (optional)
     ...
     */
    public function getcreditNotePositions($credit_note_id = null, $credit_note_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getcreditNotePositions'][0])
    {
        list($response) = $this->getcreditNotePositionsWithHttpInfo($credit_note_id, $credit_note_object_name, $count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getcreditNotePositionsWithHttpInfo($credit_note_id = null, $credit_note_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getcreditNotePositions'][0])
    {
        $request = $this->getcreditNotePositionsRequest($credit_note_id, $credit_note_object_name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     */
    public function getcreditNotePositionsAsync($credit_note_id = null, $credit_note_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getcreditNotePositions'][0])
    {
        return $this->getcreditNotePositionsAsyncWithHttpInfo($credit_note_id, $credit_note_object_name, $count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getcreditNotePositionsAsyncWithHttpInfo($credit_note_id = null, $credit_note_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getcreditNotePositions'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetcreditNotePositions200Response';
        $request = $this->getcreditNotePositionsRequest($credit_note_id, $credit_note_object_name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     */
    public function getcreditNotePositionsRequest($credit_note_id = null, $credit_note_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getcreditNotePositions'][0])
    {
