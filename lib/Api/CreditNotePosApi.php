...
class CreditNotePosApi
{
     ...
     *
     * @param  int|null $credit_note_id Retrieve all creditNote positions belonging to this creditNote. Must be provided with creditNote[objectName] (optional)
     * @param  string|null $credit_note_object_name Only required if creditNote[id] was provided. &#39;creditNote&#39; should be used as value. (optional)
     ...
     */
    public function getcreditNotePositions($credit_note_id = null, $credit_note_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getcreditNotePositions'][0])
    {
        list($response) = $this->getcreditNotePositionsWithHttpInfo($credit_note_id, $credit_note_object_name, $count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getcreditNotePositionsWithHttpInfo($credit_note_id = null, $credit_note_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getcreditNotePositions'][0])
    {
        $request = $this->getcreditNotePositionsRequest($credit_note_id, $credit_note_object_name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     */
    public function getcreditNotePositionsAsync($credit_note_id = null, $credit_note_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getcreditNotePositions'][0])
    {
        return $this->getcreditNotePositionsAsyncWithHttpInfo($credit_note_id, $credit_note_object_name, $count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getcreditNotePositionsAsyncWithHttpInfo($credit_note_id = null, $credit_note_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getcreditNotePositions'][0])
    {
     ...
     */
    public function getcreditNotePositionsRequest($credit_note_id = null, $credit_note_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getcreditNotePositions'][0])
    {
