...
class DocumentApi
{
     ...
     * Retrieve documents
     *
     * @param  GetDocumentsContactParameter $contact Retrieve all documents for this contact. The value of contact[objectName] must be &#39;Contact&#39;. (optional)
     * @param  bool $count_all If all documents should be counted (optional)
     * @param  int $limit The max number of documents (optional)
     ...
     */
    public function getDocuments($contact = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
        list($response) = $this->getDocumentsWithHttpInfo($contact, $count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getDocumentsWithHttpInfo($contact = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
        $request = $this->getDocumentsRequest($contact, $count_all, $limit, $offset, $embed, $contentType);
     ...
     */
    public function getDocumentsAsync($contact = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
        return $this->getDocumentsAsyncWithHttpInfo($contact, $count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentsAsyncWithHttpInfo($contact = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetDocuments200Response';
        $request = $this->getDocumentsRequest($contact, $count_all, $limit, $offset, $embed, $contentType);
     ...
     */
    public function getDocumentsRequest($contact = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
