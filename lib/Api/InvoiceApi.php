...
class InvoiceApi
{
     ...
     * @param  \Itsmind\Sevdesk\Model\GetInvoicesContactParameter $contact Retrieve all invoices with this contact. The value of contact[objectName] must be &#39;Contact&#39;. (optional)
     * @param  \Itsmind\Sevdesk\Model\GetInvoicesPaymentMethodParameter $payment_method Retrieve all invoices with this paymentMethod. The value of paymentMethod[objectName] must be &#39;PaymentMethod&#39;. (optional)
     * @param  string[] $embed embed (optional)
