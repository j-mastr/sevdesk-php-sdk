...
/**
    ...
    public function bookInvoiceRequest($invoice_id, $book_invoice_request = null, string $contentType = self::contentTypes['bookInvoice'][0])
    {
        ...
        if (isset($book_invoice_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($book_invoice_request));
            } else {
    ...
    public function createInvoiceByFactoryRequest($save_invoice = null, string $contentType = self::contentTypes['createInvoiceByFactory'][0])
    {
        ...
        if (isset($save_invoice)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($save_invoice));
            } else {
    ...
    public function createInvoiceReminderRequest($invoice_id, $invoice_object_name, $create_invoice_reminder_request = null, string $contentType = self::contentTypes['createInvoiceReminder'][0])
    {
        ...
        if (isset($create_invoice_reminder_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_invoice_reminder_request));
            } else {
     ...
     * @return \Itsmind\Sevdesk\Model\GetInvoiceById200Response
     */
    public function getInvoices($status = null, $invoice_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getInvoices'][0])
    {
        list($response) = $this->getInvoicesWithHttpInfo($status, $invoice_number, $start_date, $end_date, $contact_id, $contact_object_name, $contentType);
        return $response;
    }
     ...
     * @return array of \Itsmind\Sevdesk\Model\GetInvoiceById200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInvoicesWithHttpInfo($status = null, $invoice_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getInvoices'][0])
    {
        $request = $this->getInvoicesRequest($status, $invoice_number, $start_date, $end_date, $contact_id, $contact_object_name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoicesAsync($status = null, $invoice_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getInvoices'][0])
    {
        return $this->getInvoicesAsyncWithHttpInfo($status, $invoice_number, $start_date, $end_date, $contact_id, $contact_object_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoicesAsyncWithHttpInfo($status = null, $invoice_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getInvoices'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetInvoiceById200Response';
        $request = $this->getInvoicesRequest($status, $invoice_number, $start_date, $end_date, $contact_id, $contact_object_name, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInvoicesRequest($status = null, $invoice_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getInvoices'][0])
    {
    ...
    public function invoiceRenderRequest($invoice_id, $invoice_render_request = null, string $contentType = self::contentTypes['invoiceRender'][0])
    {
        ...
        if (isset($invoice_render_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($invoice_render_request));
            } else {
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\InvoiceSendBy200Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\InvoiceSendBy200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function invoiceSendByWithHttpInfo($invoice_id, $invoice_send_by_request = null, string $contentType = self::contentTypes['invoiceSendBy'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\InvoiceSendBy200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\InvoiceSendBy200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\InvoiceSendBy200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Itsmind\Sevdesk\Model\InvoiceSendBy200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\InvoiceSendBy200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function invoiceSendByRequest($invoice_id, $invoice_send_by_request = null, string $contentType = self::contentTypes['invoiceSendBy'][0])
    {
        ...
        if (isset($invoice_send_by_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($invoice_send_by_request));
            } else {
    ...
    public function sendInvoiceViaEMailRequest($invoice_id, $send_invoice_via_e_mail_request = null, string $contentType = self::contentTypes['sendInvoiceViaEMail'][0])
    {
        ...
        if (isset($send_invoice_via_e_mail_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($send_invoice_via_e_mail_request));
            } else {
