...
class InvoicePosApi
{
     ...
     * @param  bool $count_all If all invoice pos should be counted (optional)
     * @param  int $limit The max number of invoice pos (optional)
    ...
    {
        list($response) = $this->getInvoicePosWithHttpInfo($id, $invoice_id, $invoice_object_name, $part_id, $part_object_name, $count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getInvoicePosAsync($id = null, $invoice_id = null, $invoice_object_name = null, $part_id = null, $part_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getInvoicePos'][0])
    {
        return $this->getInvoicePosAsyncWithHttpInfo($id, $invoice_id, $invoice_object_name, $part_id, $part_object_name, $count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function getInvoicePosRequest($id = null, $invoice_id = null, $invoice_object_name = null, $part_id = null, $part_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getInvoicePos'][0])
    {
