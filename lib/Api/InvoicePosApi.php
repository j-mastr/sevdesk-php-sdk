...
class InvoicePosApi
{
     ...
     * Retrieve InvoicePos
     *
     * @param  float|null $id Retrieve all InvoicePos with this InvoicePos id (optional)
     * @param  float|null $invoice_id Retrieve all invoices positions with this invoice. Must be provided with invoice[objectName] (optional)
     * @param  string|null $invoice_object_name Only required if invoice[id] was provided. &#39;Invoice&#39; should be used as value. (optional)
     * @param  float|null $part_id Retrieve all invoices positions with this part. Must be provided with part[objectName] (optional)
     * @param  string|null $part_object_name Only required if part[id] was provided. &#39;Part&#39; should be used as value. (optional)
     ...
     */
    public function getInvoicePos($id = null, $invoice_id = null, $invoice_object_name = null, $part_id = null, $part_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getInvoicePos'][0])
    {
        list($response) = $this->getInvoicePosWithHttpInfo($id, $invoice_id, $invoice_object_name, $part_id, $part_object_name, $count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getInvoicePosWithHttpInfo($id = null, $invoice_id = null, $invoice_object_name = null, $part_id = null, $part_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getInvoicePos'][0])
    {
        $request = $this->getInvoicePosRequest($id, $invoice_id, $invoice_object_name, $part_id, $part_object_name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     */
    public function getInvoicePosAsync($id = null, $invoice_id = null, $invoice_object_name = null, $part_id = null, $part_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getInvoicePos'][0])
    {
        return $this->getInvoicePosAsyncWithHttpInfo($id, $invoice_id, $invoice_object_name, $part_id, $part_object_name, $count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoicePosAsyncWithHttpInfo($id = null, $invoice_id = null, $invoice_object_name = null, $part_id = null, $part_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getInvoicePos'][0])
    {
     ...
     */
    public function getInvoicePosRequest($id = null, $invoice_id = null, $invoice_object_name = null, $part_id = null, $part_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getInvoicePos'][0])
    {
