...
class OrderApi
{
     ...
     * @param  \Itsmind\Sevdesk\Model\ModelCreatePackingListFromOrder|null $model_create_packing_list_from_order Create contract note (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\UpdateOrder200Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\UpdateOrder200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createContractNoteFromOrderWithHttpInfo($order_id, $order_object_name, $model_create_packing_list_from_order = null, string $contentType = self::contentTypes['createContractNoteFromOrder'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\UpdateOrder200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\UpdateOrder200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\UpdateOrder200Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\UpdateOrder200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\UpdateOrder200Response',
     ...
     * Create a new order
     *
     * @param  \Itsmind\Sevdesk\Model\SaveOrder|null $save_order Creation data. Please be aware, that you need to provide at least all required parameter      of the order model! (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\CreateOrder201Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\CreateOrder201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOrderWithHttpInfo($save_order = null, string $contentType = self::contentTypes['createOrder'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\CreateOrder201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\CreateOrder201Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\CreateOrder201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\CreateOrder201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\CreateOrder201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $order_id the id of the order (required)
     * @param  string $order_object_name Model name, which is &#39;Order&#39; (required)
     * @param  \Itsmind\Sevdesk\Model\ModelCreatePackingListFromOrder|null $model_create_packing_list_from_order Create packing list (optional)
     ...
     */
    public function getDiscounts($order_id, $limit = null, $offset = null, $embed = null, $count_all = null, string $contentType = self::contentTypes['getDiscounts'][0])
    {
        list($response) = $this->getDiscountsWithHttpInfo($order_id, $limit, $offset, $embed, $count_all, $contentType);
        return $response;
    }
     ...
     */
    public function getDiscountsWithHttpInfo($order_id, $limit = null, $offset = null, $embed = null, $count_all = null, string $contentType = self::contentTypes['getDiscounts'][0])
    {
        $request = $this->getDiscountsRequest($order_id, $limit, $offset, $embed, $count_all, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDiscountsAsync($order_id, $limit = null, $offset = null, $embed = null, $count_all = null, string $contentType = self::contentTypes['getDiscounts'][0])
    {
        return $this->getDiscountsAsyncWithHttpInfo($order_id, $limit, $offset, $embed, $count_all, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDiscountsAsyncWithHttpInfo($order_id, $limit = null, $offset = null, $embed = null, $count_all = null, string $contentType = self::contentTypes['getDiscounts'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetDiscounts200Response';
        $request = $this->getDiscountsRequest($order_id, $limit, $offset, $embed, $count_all, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDiscountsRequest($order_id, $limit = null, $offset = null, $embed = null, $count_all = null, string $contentType = self::contentTypes['getDiscounts'][0])
    {
     ...
     */
    public function getOrderPositionsById($order_id, $limit = null, $offset = null, $embed = null, $count_all = null, string $contentType = self::contentTypes['getOrderPositionsById'][0])
    {
        list($response) = $this->getOrderPositionsByIdWithHttpInfo($order_id, $limit, $offset, $embed, $count_all, $contentType);
        return $response;
    }
     ...
     */
    public function getOrderPositionsByIdWithHttpInfo($order_id, $limit = null, $offset = null, $embed = null, $count_all = null, string $contentType = self::contentTypes['getOrderPositionsById'][0])
    {
        $request = $this->getOrderPositionsByIdRequest($order_id, $limit, $offset, $embed, $count_all, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderPositionsByIdAsync($order_id, $limit = null, $offset = null, $embed = null, $count_all = null, string $contentType = self::contentTypes['getOrderPositionsById'][0])
    {
        return $this->getOrderPositionsByIdAsyncWithHttpInfo($order_id, $limit, $offset, $embed, $count_all, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderPositionsByIdAsyncWithHttpInfo($order_id, $limit = null, $offset = null, $embed = null, $count_all = null, string $contentType = self::contentTypes['getOrderPositionsById'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetOrderPositionsById200Response';
        $request = $this->getOrderPositionsByIdRequest($order_id, $limit, $offset, $embed, $count_all, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderPositionsByIdRequest($order_id, $limit = null, $offset = null, $embed = null, $count_all = null, string $contentType = self::contentTypes['getOrderPositionsById'][0])
    {
     ...
     * Retrieve orders
     *
     * @param  int|null $status Status of the order (optional)
     * @param  string|null $order_number Retrieve all orders with this order number (optional)
     * @param  int|null $start_date Retrieve all orders with a date equal or higher (optional)
     * @param  int|null $end_date Retrieve all orders with a date equal or lower (optional)
     * @param  int|null $contact_id Retrieve all orders with this contact. Must be provided with contact[objectName] (optional)
     ...
     */
    public function getOrders($status = null, $order_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        list($response) = $this->getOrdersWithHttpInfo($status, $order_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getOrdersWithHttpInfo($status = null, $order_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        $request = $this->getOrdersRequest($status, $order_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrdersAsync($status = null, $order_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        return $this->getOrdersAsyncWithHttpInfo($status, $order_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrdersAsyncWithHttpInfo($status = null, $order_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetOrders200Response';
        $request = $this->getOrdersRequest($status, $order_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrdersRequest($status = null, $order_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getOrders'][0])
    {
     ...
     *
     * @param  int $order_id ID of order to return the positions (required)
     * @param  bool|null $include_itself Define if the related objects include the order itself (optional)
     * @param  bool|null $sort_by_type Define if you want the related objects sorted by type (optional)
     * @param  string[]|null $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     * @param  bool|null $count_all If all objects should be counted (optional)
     * @param  int|null $offset Which offset to start with (optional)
     * @param  int|null $limit The max number of objects to return (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\GetOrderPositionsById200Response
     */
    public function getRelatedObjects($order_id, $include_itself = null, $sort_by_type = null, $embed = null, $count_all = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRelatedObjects'][0])
    {
        list($response) = $this->getRelatedObjectsWithHttpInfo($order_id, $include_itself, $sort_by_type, $embed, $count_all, $offset, $limit, $contentType);
        return $response;
    }
     ...
     * @return array of \Itsmind\Sevdesk\Model\GetOrderPositionsById200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRelatedObjectsWithHttpInfo($order_id, $include_itself = null, $sort_by_type = null, $embed = null, $count_all = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRelatedObjects'][0])
    {
        $request = $this->getRelatedObjectsRequest($order_id, $include_itself, $sort_by_type, $embed, $count_all, $offset, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRelatedObjectsAsync($order_id, $include_itself = null, $sort_by_type = null, $embed = null, $count_all = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRelatedObjects'][0])
    {
        return $this->getRelatedObjectsAsyncWithHttpInfo($order_id, $include_itself, $sort_by_type, $embed, $count_all, $offset, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRelatedObjectsAsyncWithHttpInfo($order_id, $include_itself = null, $sort_by_type = null, $embed = null, $count_all = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRelatedObjects'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetOrderPositionsById200Response';
        $request = $this->getRelatedObjectsRequest($order_id, $include_itself, $sort_by_type, $embed, $count_all, $offset, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRelatedObjectsRequest($order_id, $include_itself = null, $sort_by_type = null, $embed = null, $count_all = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRelatedObjects'][0])
    {
     ...
     * @param  bool|null $download If u want to download the pdf of the order. (optional)
     * @param  bool|null $prevent_send_by Defines if u want to send the order. (optional)
     ...
     * @param  \Itsmind\Sevdesk\Model\OrderSendByRequest|null $order_send_by_request Specify the send type (optional)
     ...
     * @param  \Itsmind\Sevdesk\Model\SendorderViaEMailRequest|null $sendorder_via_e_mail_request Mail data (optional)
     ...
     * @param  \Itsmind\Sevdesk\Model\ModelOrderUpdate|null $model_order_update Update data (optional)
