...
class OrderApi
{
     ...
     * @param  bool $count_all If all orders should be counted (optional)
     * @param  int $limit The max number of orders (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\GetOrders200Response
     */
    public function getOrders($status = null, $order_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        list($response) = $this->getOrdersWithHttpInfo($status, $order_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     * @return array of \Itsmind\Sevdesk\Model\GetOrders200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrdersWithHttpInfo($status = null, $order_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        $request = $this->getOrdersRequest($status, $order_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrdersAsync($status = null, $order_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        return $this->getOrdersAsyncWithHttpInfo($status, $order_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrdersAsyncWithHttpInfo($status = null, $order_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetOrders200Response';
        $request = $this->getOrdersRequest($status, $order_number, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrdersRequest($status = null, $order_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getOrders'][0])
    {
