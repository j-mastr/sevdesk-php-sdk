...
class OrderPosApi
{
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\GetOrderPositionById200Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\GetOrderPositionById200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderPositionByIdWithHttpInfo($order_pos_id, string $contentType = self::contentTypes['getOrderPositionById'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\GetOrderPositionById200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\GetOrderPositionById200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\GetOrderPositionById200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\GetOrderPositionById200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\GetOrderPositionById200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int|null $order_id Retrieve all order positions belonging to this order. Must be provided with voucher[objectName] (optional)
     * @param  string|null $order_object_name Only required if order[id] was provided. &#39;Order&#39; should be used as value. (optional)
     ...
     */
    public function getOrderPositions($order_id = null, $order_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getOrderPositions'][0])
    {
        list($response) = $this->getOrderPositionsWithHttpInfo($order_id, $order_object_name, $count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getOrderPositionsWithHttpInfo($order_id = null, $order_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getOrderPositions'][0])
    {
        $request = $this->getOrderPositionsRequest($order_id, $order_object_name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderPositionsAsync($order_id = null, $order_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getOrderPositions'][0])
    {
        return $this->getOrderPositionsAsyncWithHttpInfo($order_id, $order_object_name, $count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderPositionsAsyncWithHttpInfo($order_id = null, $order_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getOrderPositions'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetOrderPositionsById200Response';
        $request = $this->getOrderPositionsRequest($order_id, $order_object_name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderPositionsRequest($order_id = null, $order_object_name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getOrderPositions'][0])
    {
     ...
     * @param  \Itsmind\Sevdesk\Model\ModelOrderPosUpdate|null $model_order_pos_update Update data (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\UpdateOrderPosition200Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\UpdateOrderPosition200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOrderPositionWithHttpInfo($order_pos_id, $model_order_pos_update = null, string $contentType = self::contentTypes['updateOrderPosition'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\UpdateOrderPosition200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\UpdateOrderPosition200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\UpdateOrderPosition200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\UpdateOrderPosition200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\UpdateOrderPosition200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
