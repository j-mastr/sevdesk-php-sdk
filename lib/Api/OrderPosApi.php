...
class OrderPosApi
{
     ...
     * @param  bool $count_all If all order pos should be counted (optional)
     * @param  int $limit The max number of order pos (optional)
    ...
    {
        list($response) = $this->getOrderPositionsWithHttpInfo($order_id, $order_object_name, $count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderPositionsAsync($order_id = null, $order_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getOrderPositions'][0])
    {
        return $this->getOrderPositionsAsyncWithHttpInfo($order_id, $order_object_name, $count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderPositionsRequest($order_id = null, $order_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getOrderPositions'][0])
    {
