...
class PartApi
{
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ModelPart, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPartWithHttpInfo($model_part = null, string $contentType = self::contentTypes['createPart'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\ModelPart' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ModelPart' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ModelPart', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Itsmind\Sevdesk\Model\ModelPart';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\ModelPart',
     ...
     * @param  bool $count_all If all parts should be counted (optional)
     * @param  int $limit The max number of parts (optional)
     ...
     */
    public function getParts($part_number = null, $name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getParts'][0])
    {
        list($response) = $this->getPartsWithHttpInfo($part_number, $name, $count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getPartsWithHttpInfo($part_number = null, $name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getParts'][0])
    {
        $request = $this->getPartsRequest($part_number, $name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartsAsync($part_number = null, $name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getParts'][0])
    {
        return $this->getPartsAsyncWithHttpInfo($part_number, $name, $count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartsAsyncWithHttpInfo($part_number = null, $name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getParts'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetParts200Response';
        $request = $this->getPartsRequest($part_number, $name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPartsRequest($part_number = null, $name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getParts'][0])
    {
