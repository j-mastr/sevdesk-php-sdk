...
class PartApi
{
     ...
     * Create a new part
     *
     * @param  \Itsmind\Sevdesk\Model\ModelPart|null $model_part Creation data. Please be aware, that you need to provide at least all required parameter      of the part model! (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\CreatePart201Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\CreatePart201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPartWithHttpInfo($model_part = null, string $contentType = self::contentTypes['createPart'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\CreatePart201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\CreatePart201Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\CreatePart201Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\CreatePart201Response';
     ...
     * Retrieve parts
     *
     * @param  string|null $part_number Retrieve all parts with this part number (optional)
     * @param  string|null $name Retrieve all parts with this name (optional)
     ...
     */
    public function getParts($part_number = null, $name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getParts'][0])
    {
        list($response) = $this->getPartsWithHttpInfo($part_number, $name, $count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getPartsWithHttpInfo($part_number = null, $name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getParts'][0])
    {
        $request = $this->getPartsRequest($part_number, $name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartsAsync($part_number = null, $name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getParts'][0])
    {
        return $this->getPartsAsyncWithHttpInfo($part_number, $name, $count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartsAsyncWithHttpInfo($part_number = null, $name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getParts'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetParts200Response';
        $request = $this->getPartsRequest($part_number, $name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPartsRequest($part_number = null, $name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getParts'][0])
    {
     ...
     * @param  \Itsmind\Sevdesk\Model\ModelPartUpdate|null $model_part_update Update data (optional)
