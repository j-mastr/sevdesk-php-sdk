...
/**
 * PrivateTransactionRuleApi Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PrivateTransactionRuleApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation createPrivateTransactionRule
     *
     * Create a new rule
     *
     * @param  \Itsmind\Sevdesk\Model\CreatePrivateTransactionRule|null $create_private_transaction_rule create_private_transaction_rule (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPrivateTransactionRule'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\ModelPrivateTransactionRuleResponse
     */
    public function createPrivateTransactionRule($create_private_transaction_rule = null, string $contentType = self::contentTypes['createPrivateTransactionRule'][0])
    {
        list($response) = $this->createPrivateTransactionRuleWithHttpInfo($create_private_transaction_rule, $contentType);
        return $response;
    }

    /**
     * Operation createPrivateTransactionRuleWithHttpInfo
     *
     * Create a new rule
     *
     * @param  \Itsmind\Sevdesk\Model\CreatePrivateTransactionRule|null $create_private_transaction_rule (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPrivateTransactionRule'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ModelPrivateTransactionRuleResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPrivateTransactionRuleWithHttpInfo($create_private_transaction_rule = null, string $contentType = self::contentTypes['createPrivateTransactionRule'][0])
    {
        $request = $this->createPrivateTransactionRuleRequest($create_private_transaction_rule, $contentType);
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\Itsmind\Sevdesk\Model\ModelPrivateTransactionRuleResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation createPrivateTransactionRuleAsync
     *
     * Create a new rule
     *
     * @param  \Itsmind\Sevdesk\Model\CreatePrivateTransactionRule|null $create_private_transaction_rule (optional)
     ...
     */
    public function createPrivateTransactionRuleAsync($create_private_transaction_rule = null, string $contentType = self::contentTypes['createPrivateTransactionRule'][0])
    {
        return $this->createPrivateTransactionRuleAsyncWithHttpInfo($create_private_transaction_rule, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createPrivateTransactionRuleAsyncWithHttpInfo
     *
     * Create a new rule
     *
     * @param  \Itsmind\Sevdesk\Model\CreatePrivateTransactionRule|null $create_private_transaction_rule (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPrivateTransactionRuleAsyncWithHttpInfo($create_private_transaction_rule = null, string $contentType = self::contentTypes['createPrivateTransactionRule'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\ModelPrivateTransactionRuleResponse';
        $request = $this->createPrivateTransactionRuleRequest($create_private_transaction_rule, $contentType);
    ...
    /**
     * Create request for operation 'createPrivateTransactionRule'
     *
     * @param  \Itsmind\Sevdesk\Model\CreatePrivateTransactionRule|null $create_private_transaction_rule (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPrivateTransactionRule'] to see the possible values for this operation
     *
     ...
     */
    public function createPrivateTransactionRuleRequest($create_private_transaction_rule = null, string $contentType = self::contentTypes['createPrivateTransactionRule'][0])
    {



        $resourcePath = '/PrivateTransactionRule';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($create_private_transaction_rule)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_private_transaction_rule));
            } else {
                $httpBody = $create_private_transaction_rule;
            }
    ...
    /**
     * Operation deletePrivateTransactionRule
     *
     * Delete the rule by id
     *
     * @param  int $id Id of the rule to delete (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deletePrivateTransactionRule'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\DeleteCheckAccount200Response
     */
    public function deletePrivateTransactionRule($id, string $contentType = self::contentTypes['deletePrivateTransactionRule'][0])
    {
        list($response) = $this->deletePrivateTransactionRuleWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation deletePrivateTransactionRuleWithHttpInfo
     *
     * Delete the rule by id
     *
     * @param  int $id Id of the rule to delete (required)
     ...
     */
    public function deletePrivateTransactionRuleWithHttpInfo($id, string $contentType = self::contentTypes['deletePrivateTransactionRule'][0])
    {
        $request = $this->deletePrivateTransactionRuleRequest($id, $contentType);
    ...
    /**
     * Operation deletePrivateTransactionRuleAsync
     *
     * Delete the rule by id
     *
     * @param  int $id Id of the rule to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletePrivateTransactionRuleAsync($id, string $contentType = self::contentTypes['deletePrivateTransactionRule'][0])
    {
        return $this->deletePrivateTransactionRuleAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deletePrivateTransactionRuleAsyncWithHttpInfo
     *
     * Delete the rule by id
     *
     * @param  int $id Id of the rule to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletePrivateTransactionRuleAsyncWithHttpInfo($id, string $contentType = self::contentTypes['deletePrivateTransactionRule'][0])
    {
    ...
    /**
     * Create request for operation 'deletePrivateTransactionRule'
     *
     * @param  int $id Id of the rule to delete (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deletePrivateTransactionRule'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deletePrivateTransactionRuleRequest($id, string $contentType = self::contentTypes['deletePrivateTransactionRule'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deletePrivateTransactionRule'
            );
        }


        $resourcePath = '/PrivateTransactionRule/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation listPrivateTransactionRules
     *
     * List existing rules
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listPrivateTransactionRules'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\ListPrivateTransactionRules200Response
     */
    public function listPrivateTransactionRules(string $contentType = self::contentTypes['listPrivateTransactionRules'][0])
    {
        list($response) = $this->listPrivateTransactionRulesWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation listPrivateTransactionRulesWithHttpInfo
     *
     * List existing rules
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listPrivateTransactionRules'] to see the possible values for this operation
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ListPrivateTransactionRules200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function listPrivateTransactionRulesWithHttpInfo(string $contentType = self::contentTypes['listPrivateTransactionRules'][0])
    {
        $request = $this->listPrivateTransactionRulesRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Itsmind\Sevdesk\Model\ListPrivateTransactionRules200Response',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation listPrivateTransactionRulesAsync
     *
     * List existing rules
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listPrivateTransactionRules'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listPrivateTransactionRulesAsync(string $contentType = self::contentTypes['listPrivateTransactionRules'][0])
    {
        return $this->listPrivateTransactionRulesAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listPrivateTransactionRulesAsyncWithHttpInfo
     *
     * List existing rules
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listPrivateTransactionRules'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listPrivateTransactionRulesAsyncWithHttpInfo(string $contentType = self::contentTypes['listPrivateTransactionRules'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\ListPrivateTransactionRules200Response';
        $request = $this->listPrivateTransactionRulesRequest($contentType);
    ...
    /**
     * Create request for operation 'listPrivateTransactionRules'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listPrivateTransactionRules'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listPrivateTransactionRulesRequest(string $contentType = self::contentTypes['listPrivateTransactionRules'][0])
    {
