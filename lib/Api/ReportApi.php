...
class ReportApi
{
     ...
     * Export contact list
     *
     * @param  \Itsmind\Sevdesk\Model\ReportContactSevQueryParameter $sev_query sev_query (required)
     ...
     * @return \Itsmind\Sevdesk\Model\ReportContact200Response
     */
     ...
     * Export contact list
     *
     * @param  \Itsmind\Sevdesk\Model\ReportContactSevQueryParameter $sev_query (required)
     * @param  bool|null $download (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['reportContact'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ReportContact200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function reportContactWithHttpInfo($sev_query, $download = null, string $contentType = self::contentTypes['reportContact'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\ReportContact200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ReportContact200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ReportContact200Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\ReportContact200Response';
     ...
     * @param  \Itsmind\Sevdesk\Model\ReportInvoiceSevQueryParameter $sev_query sev_query (required)
     * @param  bool|null $download download (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\ReportInvoice200Response
     */
    public function reportInvoice($view, $sev_query, $download = null, string $contentType = self::contentTypes['reportInvoice'][0])
    {
        list($response) = $this->reportInvoiceWithHttpInfo($view, $sev_query, $download, $contentType);
        return $response;
    }
     ...
     * @param  \Itsmind\Sevdesk\Model\ReportInvoiceSevQueryParameter $sev_query (required)
     * @param  bool|null $download (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['reportInvoice'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ReportInvoice200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function reportInvoiceWithHttpInfo($view, $sev_query, $download = null, string $contentType = self::contentTypes['reportInvoice'][0])
    {
        $request = $this->reportInvoiceRequest($view, $sev_query, $download, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\ReportInvoice200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ReportInvoice200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ReportInvoice200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\ReportInvoice200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportInvoiceAsync($view, $sev_query, $download = null, string $contentType = self::contentTypes['reportInvoice'][0])
    {
        return $this->reportInvoiceAsyncWithHttpInfo($view, $sev_query, $download, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportInvoiceAsyncWithHttpInfo($view, $sev_query, $download = null, string $contentType = self::contentTypes['reportInvoice'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\ReportInvoice200Response';
        $request = $this->reportInvoiceRequest($view, $sev_query, $download, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function reportInvoiceRequest($view, $sev_query, $download = null, string $contentType = self::contentTypes['reportInvoice'][0])
    {
     ...
     *
     * @param  string $view view (required)
     * @param  \Itsmind\Sevdesk\Model\ReportOrderSevQueryParameter $sev_query sev_query (required)
     * @param  bool|null $download download (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\ReportOrder200Response
     */
    public function reportOrder($view, $sev_query, $download = null, string $contentType = self::contentTypes['reportOrder'][0])
    {
        list($response) = $this->reportOrderWithHttpInfo($view, $sev_query, $download, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $view (required)
     * @param  \Itsmind\Sevdesk\Model\ReportOrderSevQueryParameter $sev_query (required)
     * @param  bool|null $download (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['reportOrder'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ReportOrder200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function reportOrderWithHttpInfo($view, $sev_query, $download = null, string $contentType = self::contentTypes['reportOrder'][0])
    {
        $request = $this->reportOrderRequest($view, $sev_query, $download, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\ReportOrder200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ReportOrder200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ReportOrder200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\ReportOrder200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportOrderAsync($view, $sev_query, $download = null, string $contentType = self::contentTypes['reportOrder'][0])
    {
        return $this->reportOrderAsyncWithHttpInfo($view, $sev_query, $download, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportOrderAsyncWithHttpInfo($view, $sev_query, $download = null, string $contentType = self::contentTypes['reportOrder'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\ReportOrder200Response';
        $request = $this->reportOrderRequest($view, $sev_query, $download, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function reportOrderRequest($view, $sev_query, $download = null, string $contentType = self::contentTypes['reportOrder'][0])
    {
     ...
     * Export voucher list
     *
     * @param  \Itsmind\Sevdesk\Model\ReportVoucherSevQueryParameter $sev_query sev_query (required)
     * @param  bool|null $download download (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\ReportVoucher200Response
     */
     ...
     * Export voucher list
     *
     * @param  \Itsmind\Sevdesk\Model\ReportVoucherSevQueryParameter $sev_query (required)
     * @param  bool|null $download (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['reportVoucher'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ReportVoucher200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function reportVoucherWithHttpInfo($sev_query, $download = null, string $contentType = self::contentTypes['reportVoucher'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\ReportVoucher200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ReportVoucher200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ReportVoucher200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\ReportVoucher200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
