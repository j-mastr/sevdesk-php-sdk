...
class SevUserApi
{
    ...
    /**
     * Operation getSevUserById
     *
     * @param  int $sev_user_id sev_user_id (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSevUserById'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\GetSevUserById200Response
     */
    public function getSevUserById($sev_user_id, $embed = null, string $contentType = self::contentTypes['getSevUserById'][0])
    {
        list($response) = $this->getSevUserByIdWithHttpInfo($sev_user_id, $embed, $contentType);
        return $response;
    }

    /**
     * Operation getSevUserByIdWithHttpInfo
     *
     * @param  int $sev_user_id (required)
     * @param  string[]|null $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSevUserById'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\GetSevUserById200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSevUserByIdWithHttpInfo($sev_user_id, $embed = null, string $contentType = self::contentTypes['getSevUserById'][0])
    {
        $request = $this->getSevUserByIdRequest($sev_user_id, $embed, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\GetSevUserById200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\GetSevUserById200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\GetSevUserById200Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\GetSevUserById200Response';
     ...
     */
    public function getSevUserByIdAsync($sev_user_id, $embed = null, string $contentType = self::contentTypes['getSevUserById'][0])
    {
        return $this->getSevUserByIdAsyncWithHttpInfo($sev_user_id, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSevUserByIdAsyncWithHttpInfo
     *
     * @param  int $sev_user_id (required)
     * @param  string[]|null $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSevUserById'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSevUserByIdAsyncWithHttpInfo($sev_user_id, $embed = null, string $contentType = self::contentTypes['getSevUserById'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetSevUserById200Response';
        $request = $this->getSevUserByIdRequest($sev_user_id, $embed, $contentType);
    ...
    /**
     * Create request for operation 'getSevUserById'
     *
     * @param  int $sev_user_id (required)
     * @param  string[]|null $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSevUserById'] to see the possible values for this operation
     ...
     */
    public function getSevUserByIdRequest($sev_user_id, $embed = null, string $contentType = self::contentTypes['getSevUserById'][0])
    {

        // verify the required parameter 'sev_user_id' is set
        if ($sev_user_id === null || (is_array($sev_user_id) && count($sev_user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sev_user_id when calling getSevUserById'
            );
        }



        $resourcePath = '/SevUser/{sevUserId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($sev_user_id !== null) {
            $resourcePath = str_replace(
                '{' . 'sevUserId' . '}',
                ObjectSerializer::toPathValue($sev_user_id),
                $resourcePath
            );
        }
     ...
     * @param  string[]|null $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     * @param  \Itsmind\Sevdesk\Model\GetSevUsersIgnoreRolesParameter|null $ignore_roles ignore_roles (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSevUsers'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\GetSevUsers200Response
     */
    public function getSevUsers($count_all = null, $offset = null, $limit = null, $embed = null, $ignore_roles = null, string $contentType = self::contentTypes['getSevUsers'][0])
    {
        list($response) = $this->getSevUsersWithHttpInfo($count_all, $offset, $limit, $embed, $ignore_roles, $contentType);
        return $response;
    }

    /**
     * Operation getSevUsersWithHttpInfo
     *
     * @param  bool|null $count_all If all objects should be counted (optional)
     * @param  int|null $offset Which offset to start with (optional)
     * @param  int|null $limit The max number of objects to return (optional)
     * @param  string[]|null $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     * @param  \Itsmind\Sevdesk\Model\GetSevUsersIgnoreRolesParameter|null $ignore_roles (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSevUsers'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\GetSevUsers200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSevUsersWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, $ignore_roles = null, string $contentType = self::contentTypes['getSevUsers'][0])
    {
        $request = $this->getSevUsersRequest($count_all, $offset, $limit, $embed, $ignore_roles, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\GetSevUsers200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\GetSevUsers200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\GetSevUsers200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\GetSevUsers200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSevUsersAsync($count_all = null, $offset = null, $limit = null, $embed = null, $ignore_roles = null, string $contentType = self::contentTypes['getSevUsers'][0])
    {
        return $this->getSevUsersAsyncWithHttpInfo($count_all, $offset, $limit, $embed, $ignore_roles, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSevUsersAsyncWithHttpInfo
     *
     * @param  bool|null $count_all If all objects should be counted (optional)
     * @param  int|null $offset Which offset to start with (optional)
     * @param  int|null $limit The max number of objects to return (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSevUsersAsyncWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, $ignore_roles = null, string $contentType = self::contentTypes['getSevUsers'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetSevUsers200Response';
        $request = $this->getSevUsersRequest($count_all, $offset, $limit, $embed, $ignore_roles, $contentType);
    ...
    /**
     * Create request for operation 'getSevUsers'
     *
     * @param  bool|null $count_all If all objects should be counted (optional)
     * @param  int|null $offset Which offset to start with (optional)
     * @param  int|null $limit The max number of objects to return (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSevUsersRequest($count_all = null, $offset = null, $limit = null, $embed = null, $ignore_roles = null, string $contentType = self::contentTypes['getSevUsers'][0])
    {
