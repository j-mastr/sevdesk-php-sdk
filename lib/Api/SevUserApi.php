...
class SevUserApi
{
     ...
     * @param  string[] $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     * @param  \Itsmind\Sevdesk\Model\GetSevUsersIgnoreRolesParameter $ignore_roles ignore_roles (optional)
     ...
     * @param  int $limit The max number of objects to return (optional)
     * @param  string[] $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     * @param  \Itsmind\Sevdesk\Model\GetSevUsersIgnoreRolesParameter $ignore_roles (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSevUsers'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
