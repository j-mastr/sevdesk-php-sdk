...
class TagApi
{
     ...
     * Create a new tag
     *
     * @param  \Itsmind\Sevdesk\Model\CreateTagRequest|null $create_tag_request create_tag_request (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\CreateTag200Response
     */
     ...
     * Create a new tag
     *
     * @param  \Itsmind\Sevdesk\Model\CreateTagRequest|null $create_tag_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createTag'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\CreateTag200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTagWithHttpInfo($create_tag_request = null, string $contentType = self::contentTypes['createTag'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\CreateTag200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\CreateTag200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\CreateTag200Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\CreateTag200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\CreateTag200Response',
     ...
     */
    public function getTagRelations($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getTagRelations'][0])
    {
        list($response) = $this->getTagRelationsWithHttpInfo($count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getTagRelationsWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getTagRelations'][0])
    {
        $request = $this->getTagRelationsRequest($count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagRelationsAsync($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getTagRelations'][0])
    {
        return $this->getTagRelationsAsyncWithHttpInfo($count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagRelationsAsyncWithHttpInfo($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getTagRelations'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetTagRelations200Response';
        $request = $this->getTagRelationsRequest($count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTagRelationsRequest($count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getTagRelations'][0])
    {
     ...
     * Retrieve tags
     *
     * @param  float|null $id ID of the Tag (optional)
     * @param  string|null $name Name of the Tag (optional)
     * @param  bool|null $count_all If all objects should be counted (optional)
     * @param  int|null $offset Which offset to start with (optional)
     * @param  int|null $limit The max number of objects to return (optional)
     * @param  string[]|null $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     ...
     */
    public function getTags($id = null, $name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getTags'][0])
    {
        list($response) = $this->getTagsWithHttpInfo($id, $name, $count_all, $offset, $limit, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getTagsWithHttpInfo($id = null, $name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getTags'][0])
    {
        $request = $this->getTagsRequest($id, $name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsync($id = null, $name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getTags'][0])
    {
        return $this->getTagsAsyncWithHttpInfo($id, $name, $count_all, $offset, $limit, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsyncWithHttpInfo($id = null, $name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getTags'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetTags200Response';
        $request = $this->getTagsRequest($id, $name, $count_all, $offset, $limit, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTagsRequest($id = null, $name = null, $count_all = null, $offset = null, $limit = null, $embed = null, string $contentType = self::contentTypes['getTags'][0])
    {
     ...
     * @param  \Itsmind\Sevdesk\Model\UpdateTagRequest|null $update_tag_request update_tag_request (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\UpdateTag200Response
     */
     ...
     *
     * @param  int $tag_id ID of tag you want to update (required)
     * @param  \Itsmind\Sevdesk\Model\UpdateTagRequest|null $update_tag_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateTag'] to see the possible values for this operation
     *
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\UpdateTag200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTagWithHttpInfo($tag_id, $update_tag_request = null, string $contentType = self::contentTypes['updateTag'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\UpdateTag200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\UpdateTag200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\UpdateTag200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Itsmind\Sevdesk\Model\UpdateTag200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\UpdateTag200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
