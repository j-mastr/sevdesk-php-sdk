...
class TagApi
{
     ...
     * @return \Itsmind\Sevdesk\Model\ModelTagCreateResponse
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ModelTagCreateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTagWithHttpInfo($create_tag_request = null, string $contentType = self::contentTypes['createTag'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\ModelTagCreateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ModelTagCreateResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ModelTagCreateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Itsmind\Sevdesk\Model\ModelTagCreateResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\ModelTagCreateResponse',
     ...
     *
     * @param  bool $count_all If all tag relations should be counted (optional)
     * @param  int $limit The max number of tag relations (optional)
     ...
     */
    public function getTagRelations($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getTagRelations'][0])
    {
        list($response) = $this->getTagRelationsWithHttpInfo($count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getTagRelationsWithHttpInfo($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getTagRelations'][0])
    {
        $request = $this->getTagRelationsRequest($count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagRelationsAsync($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getTagRelations'][0])
    {
        return $this->getTagRelationsAsyncWithHttpInfo($count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagRelationsAsyncWithHttpInfo($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getTagRelations'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetTagRelations200Response';
        $request = $this->getTagRelationsRequest($count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTagRelationsRequest($count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getTagRelations'][0])
    {
     ...
     * @param  bool $count_all If all tags should be counted (optional)
     * @param  int $limit The max number of tags (optional)
     * @param  int $offset Which offset to start with (optional)
     * @param  string[] $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\GetTags200Response
     */
    public function getTags($id = null, $name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getTags'][0])
    {
        list($response) = $this->getTagsWithHttpInfo($id, $name, $count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     * @return array of \Itsmind\Sevdesk\Model\GetTags200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTagsWithHttpInfo($id = null, $name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getTags'][0])
    {
        $request = $this->getTagsRequest($id, $name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsync($id = null, $name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getTags'][0])
    {
        return $this->getTagsAsyncWithHttpInfo($id, $name, $count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsyncWithHttpInfo($id = null, $name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getTags'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetTags200Response';
        $request = $this->getTagsRequest($id, $name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTagsRequest($id = null, $name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getTags'][0])
    {
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\ModelTagResponse
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ModelTagResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTagWithHttpInfo($tag_id, $update_tag_request = null, string $contentType = self::contentTypes['updateTag'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\ModelTagResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ModelTagResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ModelTagResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Itsmind\Sevdesk\Model\ModelTagResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
