...
class TextTemplateApi
{
     ...
     *
     * @param  \Itsmind\Sevdesk\Model\ModelTextTemplate|null $model_text_template Text Template Data (optional)
     ...
     * @return \Itsmind\Sevdesk\Model\AddTextTemplate201Response
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\AddTextTemplate201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function addTextTemplateWithHttpInfo($model_text_template = null, string $contentType = self::contentTypes['addTextTemplate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Itsmind\Sevdesk\Model\AddTextTemplate201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\AddTextTemplate201Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\AddTextTemplate201Response', []),
            ...
            $returnType = '\Itsmind\Sevdesk\Model\AddTextTemplate201Response';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\AddTextTemplate201Response',
     ...
     *
     * @param  int|null $limit Limits the number of entries returned. Default is 100 (optional, default to 100)
     * @param  int|null $offset Set the index where the returned text templates start. Default is 0 (optional, default to 0)
     * @param  string[]|null $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. Default &#x60;&#x60;. (optional)
     * @param  string|null $category The category of the new Text Template. (optional)
     * @param  string|null $object_type object type for which you want to use the text template (optional)
     * @param  string|null $text_type type of your text (optional)
     ...
     */
    public function getTextTemplate($limit = 100, $offset = 0, $embed = null, $category = null, $object_type = null, $text_type = null, $count_all = null, string $contentType = self::contentTypes['getTextTemplate'][0])
    {
        list($response) = $this->getTextTemplateWithHttpInfo($limit, $offset, $embed, $category, $object_type, $text_type, $count_all, $contentType);
        return $response;
    }
     ...
     */
    public function getTextTemplateWithHttpInfo($limit = 100, $offset = 0, $embed = null, $category = null, $object_type = null, $text_type = null, $count_all = null, string $contentType = self::contentTypes['getTextTemplate'][0])
    {
        $request = $this->getTextTemplateRequest($limit, $offset, $embed, $category, $object_type, $text_type, $count_all, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTextTemplateAsync($limit = 100, $offset = 0, $embed = null, $category = null, $object_type = null, $text_type = null, $count_all = null, string $contentType = self::contentTypes['getTextTemplate'][0])
    {
        return $this->getTextTemplateAsyncWithHttpInfo($limit, $offset, $embed, $category, $object_type, $text_type, $count_all, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTextTemplateAsyncWithHttpInfo($limit = 100, $offset = 0, $embed = null, $category = null, $object_type = null, $text_type = null, $count_all = null, string $contentType = self::contentTypes['getTextTemplate'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetTextTemplate200Response';
        $request = $this->getTextTemplateRequest($limit, $offset, $embed, $category, $object_type, $text_type, $count_all, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTextTemplateRequest($limit = 100, $offset = 0, $embed = null, $category = null, $object_type = null, $text_type = null, $count_all = null, string $contentType = self::contentTypes['getTextTemplate'][0])
    {
