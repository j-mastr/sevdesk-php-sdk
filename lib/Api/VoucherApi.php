...
class VoucherApi
{
     ...
     * @param  bool $count_all If all vouchers should be counted (optional)
     * @param  int $limit The max number of vouchers (optional)
     ...
     */
    public function getVouchers($status = null, $credit_debit = null, $description_like = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getVouchers'][0])
    {
        list($response) = $this->getVouchersWithHttpInfo($status, $credit_debit, $description_like, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
        return $response;
    }
     ...
     */
    public function getVouchersWithHttpInfo($status = null, $credit_debit = null, $description_like = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getVouchers'][0])
    {
        $request = $this->getVouchersRequest($status, $credit_debit, $description_like, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVouchersAsync($status = null, $credit_debit = null, $description_like = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getVouchers'][0])
    {
        return $this->getVouchersAsyncWithHttpInfo($status, $credit_debit, $description_like, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVouchersAsyncWithHttpInfo($status = null, $credit_debit = null, $description_like = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getVouchers'][0])
    {
        $returnType = '\Itsmind\Sevdesk\Model\GetVouchers200Response';
        $request = $this->getVouchersRequest($status, $credit_debit, $description_like, $start_date, $end_date, $contact_id, $contact_object_name, $count_all, $limit, $offset, $embed, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVouchersRequest($status = null, $credit_debit = null, $description_like = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, $count_all = null, $limit = null, $offset = null, $embed = null, string $contentType = self::contentTypes['getVouchers'][0])
    {
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\ModelVoucherResponse
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\ModelVoucherResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateVoucherWithHttpInfo($voucher_id, $model_voucher_update = null, string $contentType = self::contentTypes['updateVoucher'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Itsmind\Sevdesk\Model\ModelVoucherResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Itsmind\Sevdesk\Model\ModelVoucherResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Itsmind\Sevdesk\Model\ModelVoucherResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Itsmind\Sevdesk\Model\ModelVoucherResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Itsmind\Sevdesk\Model\ModelVoucherResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Itsmind\Sevdesk\Model\SaveVoucher $save_voucher Creation data. Please be aware, that you need to provide at least all required parameters of the voucher and voucher position model! (optional)
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Itsmind\Sevdesk\Model\SaveVoucherResponse|\Itsmind\Sevdesk\Model\ValidationError
     */
     ...
     * @throws \Itsmind\Sevdesk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Itsmind\Sevdesk\Model\SaveVoucherResponse|\Itsmind\Sevdesk\Model\ValidationError, HTTP status code, HTTP response headers (array of strings)
     */
