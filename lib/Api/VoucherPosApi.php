...
class VoucherPosApi
{
     ...
     *
     * @param  int|null $voucher_id Retrieve all vouchers positions belonging to this voucher. Must be provided with voucher[objectName] (optional)
     * @param  string|null $voucher_object_name Only required if voucher[id] was provided. &#39;Voucher&#39; should be used as value. (optional)
