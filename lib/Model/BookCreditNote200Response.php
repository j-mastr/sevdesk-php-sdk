...
class BookCreditNote200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'create' => '\DateTime',
        'credit_note' => '\Itsmind\Sevdesk\Model\BookCreditNote200ResponseCreditNote',
        'from_status' => 'string',
        'to_status' => 'string',
        'ammount_payed' => 'string',
        'booking_date' => '\DateTime',
        'sev_client' => '\Itsmind\Sevdesk\Model\BookCreditNote200ResponseSevClient'
    ];
    ...
    public const OBJECT_NAME_CREDIT_NOTE_LOG = 'CreditNoteLog';
    ...
    {
        return [
            self::OBJECT_NAME_CREDIT_NOTE_LOG,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'CreditNoteLog');
        ...
        $this->setIfExists('ammount_payed', $data ?? [], null);
    ...
    */
     ...
     * Sets object_name
     *
     * @param string|null $object_name Internal object name which is 'CreditNoteLog'.
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param \DateTime|null $create Date of email creation
     *
     * @return self
     */
     ...
     * Gets credit_note
     *
     * @return \Itsmind\Sevdesk\Model\BookCreditNote200ResponseCreditNote|null
     */
     ...
     * Sets credit_note
     *
     * @param \Itsmind\Sevdesk\Model\BookCreditNote200ResponseCreditNote|null $credit_note credit_note
     *
     * @return self
     */
     ...
     * Sets from_status
     *
     * @param string|null $from_status from_status
     *
     * @return self
     */
     ...
     * Sets to_status
     *
     * @param string|null $to_status to_status
     *
     * @return self
     */
     ...
     * Sets ammount_payed
     *
     * @param string|null $ammount_payed ammount_payed
     *
     * @return self
     */
    public function setAmmountPayed($ammount_payed)
    {
        if (is_null($ammount_payed)) {
            throw new \InvalidArgumentException('non-nullable ammount_payed cannot be null');
        }
     ...
     * Gets sev_client
     *
     * @return \Itsmind\Sevdesk\Model\BookCreditNote200ResponseSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \Itsmind\Sevdesk\Model\BookCreditNote200ResponseSevClient|null $sev_client sev_client
     *
     * @return self
     */
