...
/**
 * BookCreditNoteRequestCheckAccount Class Doc Comment
 *
 * @category Class
 ...
 */
class BookCreditNoteRequestCheckAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bookCreditNote_request_checkAccount';
