...
class BookInvoice200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'create' => '\DateTime',
        'credit_note' => '\Itsmind\Sevdesk\Model\BookInvoice200ResponseCreditNote',
        'from_status' => 'string',
        'to_status' => 'string',
    ...
    public const OBJECT_NAME_INVOICE_LOG = 'InvoiceLog';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string|null $object_name Internal object name which is 'InvoiceLog'.
     *
     * @return self
     */
     ...
     * Gets credit_note
     *
     * @return \Itsmind\Sevdesk\Model\BookInvoice200ResponseCreditNote|null
     */
     ...
     * Sets credit_note
     *
     * @param \Itsmind\Sevdesk\Model\BookInvoice200ResponseCreditNote|null $credit_note credit_note
     *
     * @return self
     */
