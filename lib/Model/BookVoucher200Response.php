...
class BookVoucher200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'object_name' => 'string',
        'create' => '\DateTime',
        'voucher' => '\Itsmind\Sevdesk\Model\BookVoucher200ResponseVoucher',
        'from_status' => 'string',
        'to_status' => 'string',
        'amount_payed' => 'string',
        'booking_date' => '\DateTime',
        'sev_client' => '\Itsmind\Sevdesk\Model\BookVoucher200ResponseSevClient'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('amount_payed', $data ?? [], null);
    ...
    */
     ...
     * Gets voucher
     *
     * @return \Itsmind\Sevdesk\Model\BookVoucher200ResponseVoucher|null
     */
     ...
     * Sets voucher
     *
     * @param \Itsmind\Sevdesk\Model\BookVoucher200ResponseVoucher|null $voucher voucher
     *
     * @return self
     */
     ...
     * Sets amount_payed
     *
     * @param string|null $amount_payed amount_payed
     *
     * @return self
     */
    public function setAmountPayed($amount_payed)
    {
        if (is_null($amount_payed)) {
            throw new \InvalidArgumentException('non-nullable amount_payed cannot be null');
        }
     ...
     * Gets sev_client
     *
     * @return \Itsmind\Sevdesk\Model\BookVoucher200ResponseSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \Itsmind\Sevdesk\Model\BookVoucher200ResponseSevClient|null $sev_client sev_client
     *
     * @return self
     */
