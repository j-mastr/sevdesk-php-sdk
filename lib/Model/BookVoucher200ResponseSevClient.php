...
/**
 * BookVoucher200ResponseSevClient Class Doc Comment
 *
 * @category Class
 * @description Client to which the voucher belongs.
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BookVoucher200ResponseSevClient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bookVoucher_200_response_sevClient';
