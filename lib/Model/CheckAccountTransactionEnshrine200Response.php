...
/**
 * CheckAccountTransactionEnshrine200Response Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class CheckAccountTransactionEnshrine200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'checkAccountTransactionEnshrine_200_response';
    ...
    */
     ...
     * Sets objects
     *
     * @param mixed|null $objects objects
     *
     * @return self
     */
    ...
    {
        if (is_null($objects)) {
            array_push($this->openAPINullablesSetToNull, 'objects');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('objects', $nullablesSetToNull);
            if ($index !== FALSE) {
