...
/**
 * CreateClearingAccountResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateClearingAccountResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createClearingAccountResponse';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type The type of the check account. Clearing accounts are regarded as offline.
     *
     * @return self
     */
     ...
     *
     * @param string|null $accounting_number The booking account used for this clearing account.
     *
     * @return self
     */
