...
/**
 * CreateCreditNoteFromInvoice201ResponseObjects Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class CreateCreditNoteFromInvoice201ResponseObjects implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createCreditNoteFromInvoice_201_response_objects';
    ...
    protected static $openAPITypes = [
        'credit_note' => '\Itsmind\Sevdesk\Model\ModelCreditNoteResponse',
        'credit_note_pos' => '\Itsmind\Sevdesk\Model\ModelCreditNotePosResponse[]',
        'discount' => '\Itsmind\Sevdesk\Model\ModelDiscountsResponse[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('credit_note_pos', $data ?? [], null);
    ...
    */
     ...
     * Sets credit_note
     *
     * @param \Itsmind\Sevdesk\Model\ModelCreditNoteResponse|null $credit_note credit_note
     *
     * @return self
     */
     ...
     *
     * @param \Itsmind\Sevdesk\Model\ModelCreditNotePosResponse[]|null $credit_note_pos An array of creditNote positions
     *
     * @return self
     */
    public function setCreditNotePos($credit_note_pos)
    {
        if (is_null($credit_note_pos)) {
            throw new \InvalidArgumentException('non-nullable credit_note_pos cannot be null');
        }
     ...
     * Gets discount
     *
     * @return \Itsmind\Sevdesk\Model\ModelDiscountsResponse[]|null
     */
     ...
     * Sets discount
     *
     * @param \Itsmind\Sevdesk\Model\ModelDiscountsResponse[]|null $discount An array of discounts (can be empty)
     *
     * @return self
     */
