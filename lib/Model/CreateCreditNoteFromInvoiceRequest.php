...
/**
 * CreateCreditNoteFromInvoiceRequest Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class CreateCreditNoteFromInvoiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createCreditNoteFromInvoice_request';
    ...
    protected static $openAPITypes = [
        'invoice' => '\Itsmind\Sevdesk\Model\CreateCreditNoteFromInvoiceRequestInvoice'
    ];
    ...
    */
     ...
     * Gets invoice
     *
     * @return \Itsmind\Sevdesk\Model\CreateCreditNoteFromInvoiceRequestInvoice
     */
     ...
     * Sets invoice
     *
     * @param \Itsmind\Sevdesk\Model\CreateCreditNoteFromInvoiceRequestInvoice $invoice invoice
     *
     * @return self
     */
