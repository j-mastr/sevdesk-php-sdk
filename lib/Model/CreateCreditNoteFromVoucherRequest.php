...
/**
 * CreateCreditNoteFromVoucherRequest Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class CreateCreditNoteFromVoucherRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createCreditNoteFromVoucher_request';
    ...
    protected static $openAPITypes = [
        'voucher' => '\Itsmind\Sevdesk\Model\CreateCreditNoteFromVoucherRequestVoucher'
    ];
    ...
    */
     ...
     * Gets voucher
     *
     * @return \Itsmind\Sevdesk\Model\CreateCreditNoteFromVoucherRequestVoucher
     */
     ...
     * Sets voucher
     *
     * @param \Itsmind\Sevdesk\Model\CreateCreditNoteFromVoucherRequestVoucher $voucher voucher
     *
     * @return self
     */
