...
/**
 * CreateFileImportAccount Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class CreateFileImportAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createFileImportAccount';
    ...
    */
     ...
     *
     * @param int|null $accounting_number The booking account used for this bank account, e.g. 1800 in SKR04 and 1200 in SKR03. Must be unique among all your CheckAccounts. Ignore to use a sensible default.
     *
     * @return self
     */
    public function setAccountingNumber($accounting_number)
    {
        if (is_null($accounting_number)) {
            array_push($this->openAPINullablesSetToNull, 'accounting_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('accounting_number', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets iban
     *
     * @param string|null $iban IBAN of the bank account, without spaces
     *
     * @return self
     */
