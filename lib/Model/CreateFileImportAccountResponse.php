...
/**
 * CreateFileImportAccountResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateFileImportAccountResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createFileImportAccountResponse';
    ...
    protected static $openAPITypes = [
        ...
        'create' => '\DateTime',
        'update' => '\DateTime',
        'sev_client' => '\Itsmind\Sevdesk\Model\CreateFileImportAccountResponseSevClient',
        'name' => 'string',
        'iban' => 'string',
        'type' => 'string',
        'import_type' => 'string',
    ...
    public const DEFAULT_ACCOUNT__0 = '0';
    public const DEFAULT_ACCOUNT__1 = '1';
    public const STATUS__0 = '0';
    public const STATUS__100 = '100';
    public const AUTO_MAP_TRANSACTIONS__0 = '0';
    public const AUTO_MAP_TRANSACTIONS__1 = '1';
    ...
    {
        return [
            self::DEFAULT_ACCOUNT__0,
            self::DEFAULT_ACCOUNT__1,
        ];
    }
     ...
     * @return string[]
     */
    public function getAutoMapTransactionsAllowableValues()
    {
        return [
            self::AUTO_MAP_TRANSACTIONS__0,
            self::AUTO_MAP_TRANSACTIONS__1,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getAutoMapTransactionsAllowableValues();
        if (!is_null($this->container['auto_map_transactions']) && !in_array($this->container['auto_map_transactions'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'auto_map_transactions', must be one of '%s'",
                $this->container['auto_map_transactions'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets object_name
     *
     * @param string|null $object_name The check account object name, always 'CheckAccount'
     *
     * @return self
     */
     ...
     * Gets sev_client
     *
     * @return \Itsmind\Sevdesk\Model\CreateFileImportAccountResponseSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \Itsmind\Sevdesk\Model\CreateFileImportAccountResponseSevClient|null $sev_client sev_client
     *
     * @return self
     */
     ...
     * Sets iban
     *
     * @param string|null $iban The IBAN of the account
     *
     * @return self
     */
    ...
    public function setAutoMapTransactions($auto_map_transactions)
    {
        if (is_null($auto_map_transactions)) {
            throw new \InvalidArgumentException('non-nullable auto_map_transactions cannot be null');
        }
        $allowedValues = $this->getAutoMapTransactionsAllowableValues();
        if (!in_array($auto_map_transactions, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'auto_map_transactions', must be one of '%s'",
