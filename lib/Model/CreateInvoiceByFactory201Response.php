...
/**
 * CreateInvoiceByFactory201Response Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class CreateInvoiceByFactory201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createInvoiceByFactory_201_response';
    ...
    protected static $openAPITypes = [
        'objects' => '\Itsmind\Sevdesk\Model\SaveInvoiceResponse'
    ];
    ...
    */
     ...
     * Gets objects
     *
     * @return \Itsmind\Sevdesk\Model\SaveInvoiceResponse|null
     */
     ...
     * Sets objects
     *
     * @param \Itsmind\Sevdesk\Model\SaveInvoiceResponse|null $objects objects
     *
     * @return self
     */
