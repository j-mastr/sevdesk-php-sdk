...
/**
 * CreatePrivateTransactionRule Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class CreatePrivateTransactionRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePrivateTransactionRule';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string $object_name PrivateTransactionRule
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_purpose The purpose of transactions that you want to match
     *
     * @return self
     */
     ...
     *
     * @param string|null $counterpart_name The counterpart name of transactions that you want to match
     *
     * @return self
     */
