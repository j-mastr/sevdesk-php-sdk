...
/**
 * CreditNoteResetToDraft200ResponseObjects Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class CreditNoteResetToDraft200ResponseObjects implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'creditNoteResetToDraft_200_response_objects';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Please have a look in       <a href='#tag/CreditNote/Status-of-credit-notes'>status of credit note</a>      to see what the different status codes mean
     *
     * @return self
     */
     ...
     * Sets tax_text
     *
     * @param mixed|null $tax_text tax_text
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $customer_internal_note customer_internal_note
     *
     * @return self
     */
