...
class CreditNoteSendByRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets send_draft
     *
     * @param bool $send_draft To create a draft of a credit note for internal use. This operation will not alter the status of the credit note or create bookings for reports.
     *
     * @return self
     */
