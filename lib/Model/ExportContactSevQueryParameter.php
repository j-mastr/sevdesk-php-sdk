...
class ExportContactSevQueryParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'model_name' => 'string',
        'object_name' => 'string',
        'filter' => '\Itsmind\Sevdesk\Model\ExportContactSevQueryParameterFilter'
    ];
    ...
    public const MODEL_NAME_CONTACT = 'Contact';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('model_name', $data ?? [], 'Contact');
    ...
    */
     ...
     * Sets model_name
     *
     * @param string $model_name Model name, which is 'Contact'
     *
     * @return self
     */
     ...
     * Gets filter
     *
     * @return \Itsmind\Sevdesk\Model\ExportContactSevQueryParameterFilter|null
     */
     ...
     * Sets filter
     *
     * @param \Itsmind\Sevdesk\Model\ExportContactSevQueryParameterFilter|null $filter filter
     *
     * @return self
     */
