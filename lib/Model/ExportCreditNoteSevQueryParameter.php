...
class ExportCreditNoteSevQueryParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MODEL_NAME_CREDIT_NOTE = 'CreditNote';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('model_name', $data ?? [], 'CreditNote');
    ...
    */
     ...
     * Sets model_name
     *
     * @param string $model_name Model name, which is 'CreditNote'
     *
     * @return self
     */
