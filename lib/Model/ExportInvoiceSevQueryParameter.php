...
class ExportInvoiceSevQueryParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MODEL_NAME_INVOICE = 'Invoice';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('model_name', $data ?? [], 'Invoice');
    ...
    */
     ...
     * Sets model_name
     *
     * @param string $model_name Model name, which is 'Invoice'
     *
     * @return self
     */
