...
/**
 * ExportJobDownloadInfo Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class ExportJobDownloadInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Export_Job_Download_Info';
    ...
    protected static $attributeMap = [
        'filename' => 'filename',
        'link' => 'link',
        'link_expire_date' => 'linkExpireDate'
    ];
    ...
    protected static $setters = [
        ...
        'link' => 'setLink',
        'link_expire_date' => 'setLinkExpireDate'
    ];
    ...
    protected static $getters = [
        ...
        'link' => 'getLink',
        'link_expire_date' => 'getLinkExpireDate'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('link_expire_date', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets filename
     *
     * @param string|null $filename Current progress of the export. Export is finished when \"current\" reaches \"total\" (usually 100)
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link Download url of the export file
     *
     * @return self
     */
    ...
    /**
     * Gets link_expire_date
     *
     * @return string|null
     */
    public function getLinkExpireDate()
    {
        return $this->container['link_expire_date'];
    }

    /**
     * Sets link_expire_date
     *
     * @param string|null $link_expire_date Expire date of the download url
     *
     * @return self
     */
    public function setLinkExpireDate($link_expire_date)
    {
        if (is_null($link_expire_date)) {
            throw new \InvalidArgumentException('non-nullable link_expire_date cannot be null');
        }
        $this->container['link_expire_date'] = $link_expire_date;
