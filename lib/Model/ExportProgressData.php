...
/**
 * ExportProgressData Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class ExportProgressData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Export_Progress_Data';
    ...
    */
     ...
     * Sets current
     *
     * @param int|null $current Current progress of the export. Export is finished when \"current\" reaches \"total\" (usually 100)
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total Total value of the export
     *
     * @return self
     */
