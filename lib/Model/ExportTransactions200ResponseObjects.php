...
/**
 * ExportTransactions200ResponseObjects Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class ExportTransactions200ResponseObjects implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'exportTransactions_200_response_objects';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('base64_encoded', $data ?? [], null);
    ...
    */
     ...
     * Sets base64_encoded
     *
     * @param bool|null $base64_encoded base64_encoded
     *
     * @return self
     */
    public function setBase64Encoded($base64_encoded)
    {
        if (is_null($base64_encoded)) {
            throw new \InvalidArgumentException('non-nullable base64_encoded cannot be null');
        }
