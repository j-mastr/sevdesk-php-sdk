...
class ExportTransactionsSevQueryParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MODEL_NAME_CHECK_ACCOUNT_TRANSACTION = 'CheckAccountTransaction';
    ...
    {
        return [
            self::MODEL_NAME_CHECK_ACCOUNT_TRANSACTION,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('model_name', $data ?? [], 'CheckAccountTransaction');
    ...
    */
     ...
     * Sets model_name
     *
     * @param string $model_name Model name, which is 'CheckAccountTransaction'
     *
     * @return self
     */
