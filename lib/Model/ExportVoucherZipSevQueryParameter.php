...
/**
 * ExportVoucherZipSevQueryParameter Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class ExportVoucherZipSevQueryParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'exportVoucherZip_sevQuery_parameter';
    ...
    protected static $openAPITypes = [
        ...
        'model_name' => 'string',
        'object_name' => 'string',
        'filter' => '\Itsmind\Sevdesk\Model\ExportVoucherZipSevQueryParameterFilter'
    ];
    ...
    public const MODEL_NAME_VOUCHER = 'Voucher';
    public const OBJECT_NAME_SEV_QUERY = 'SevQuery';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('model_name', $data ?? [], 'Voucher');
        $this->setIfExists('object_name', $data ?? [], 'SevQuery');
    ...
    */
     ...
     * Sets model_name
     *
     * @param string $model_name Model name, which is 'Voucher'
     *
     * @return self
     */
    public function setModelName($model_name)
    {
        ...
        $allowedValues = $this->getModelNameAllowableValues();
        if (!in_array($model_name, $allowedValues, true)) {
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'SevQuery'
     *
     * @return self
     */
     ...
     * Gets filter
     *
     * @return \Itsmind\Sevdesk\Model\ExportVoucherZipSevQueryParameterFilter|null
     */
     ...
     * Sets filter
     *
     * @param \Itsmind\Sevdesk\Model\ExportVoucherZipSevQueryParameterFilter|null $filter filter
     *
     * @return self
     */
