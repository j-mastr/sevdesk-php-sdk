...
/**
 * ForAllAccounts200Response Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class ForAllAccounts200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'forAllAccounts_200_response';
    ...
    protected static $openAPITypes = [
        'objects' => '\Itsmind\Sevdesk\Model\ReceiptGuideDto[]'
    ];
    ...
    */
     ...
     * Gets objects
     *
     * @return \Itsmind\Sevdesk\Model\ReceiptGuideDto[]|null
     */
     ...
     * Sets objects
     *
     * @param \Itsmind\Sevdesk\Model\ReceiptGuideDto[]|null $objects objects
     *
     * @return self
     */
