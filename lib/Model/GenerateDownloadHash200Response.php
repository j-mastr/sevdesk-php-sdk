...
/**
 * GenerateDownloadHash200Response Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class GenerateDownloadHash200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generateDownloadHash_200_response';
    ...
    protected static $openAPITypes = [
        'objects' => '\Itsmind\Sevdesk\Model\ExportProgressData[]'
    ];
    ...
    */
     ...
     * Gets objects
     *
     * @return \Itsmind\Sevdesk\Model\ExportProgressData[]|null
     */
     ...
     * Sets objects
     *
     * @param \Itsmind\Sevdesk\Model\ExportProgressData[]|null $objects objects
     *
     * @return self
     */
