...
/**
 * GetCommunicationWayKeys200ResponseObjectsInner Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class GetCommunicationWayKeys200ResponseObjectsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCommunicationWayKeys_200_response_objects_inner';
    ...
    public const OBJECT_NAME_COMMUNICATION_WAY_KEY = 'CommunicationWayKey';
    ...
    {
        return [
            self::OBJECT_NAME_COMMUNICATION_WAY_KEY,
        ];
    }
