...
/**
 * GetCommunicationWays200Response Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class GetCommunicationWays200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCommunicationWays_200_response';
    ...
    */
     ...
     * Sets objects
     *
     * @param \Itsmind\Sevdesk\Model\ModelCommunicationWayResponse[] $objects objects
     *
     * @return self
     */
