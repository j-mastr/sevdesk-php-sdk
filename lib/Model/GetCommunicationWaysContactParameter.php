<?php
/**
 * GetCommunicationWaysContactParameter
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetCommunicationWaysContactParameter Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class GetCommunicationWaysContactParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCommunicationWays_contact_parameter';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID of contact for which you want the communication ways.
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Object name. Only needed if you also defined the ID of a contact. Is always 'Contact'
     *
     * @return self
     */
