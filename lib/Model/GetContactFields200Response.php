...
/**
 * GetContactFields200Response Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class GetContactFields200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getContactFields_200_response';
    ...
    */
     ...
     * Sets objects
     *
     * @param \Itsmind\Sevdesk\Model\ModelContactCustomFieldResponse[] $objects objects
     *
     * @return self
     */
