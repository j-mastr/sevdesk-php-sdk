...
/**
 * GetDocumentsContactParameter Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class GetDocumentsContactParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDocuments_contact_parameter';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string $object_name Internal object name which is 'Contact'.
     *
     * @return self
     */
