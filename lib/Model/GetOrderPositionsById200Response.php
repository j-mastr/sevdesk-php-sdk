...
/**
 * GetOrderPositionsById200Response Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderPositionsById200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOrderPositionsById_200_response';
    ...
    */
     ...
     * Sets objects
     *
     * @param \Itsmind\Sevdesk\Model\ModelOrderPosResponse[] $objects objects
     *
     * @return self
     */
