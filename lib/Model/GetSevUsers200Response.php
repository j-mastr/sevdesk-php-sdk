...
/**
 * GetSevUsers200Response Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class GetSevUsers200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getSevUsers_200_response';
    ...
    */
     ...
     * Gets objects
     *
     * @return \Itsmind\Sevdesk\Model\ModelSevUserResponse[]
     */
     ...
     * Sets objects
     *
     * @param \Itsmind\Sevdesk\Model\ModelSevUserResponse[] $objects objects
     *
     * @return self
     */
