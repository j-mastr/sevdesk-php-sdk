<?php
/**
 * InvoiceRender201ResponseAllOfParametersInnerValuesInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InvoiceRender201ResponseAllOfParametersInnerValuesInner Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceRender201ResponseAllOfParametersInnerValuesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoiceRender_201_response_allOf_parameters_inner_values_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('translation_cade', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $translation_cade translation_cade
     *
     * @return self
     */
    public function setTranslationCade($translation_cade)
    {
        if (is_null($translation_cade)) {
            throw new \InvalidArgumentException('non-nullable translation_cade cannot be null');
        }
