...
class ModelCheckAccountTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payee_payer_name'] === null && !$this->isNullableSetToNull('payee_payer_name')) {
            $invalidProperties[] = "'payee_payer_name' is required";
        }
    ...
    public function setPaymtPurpose($paymt_purpose)
    {
        if (is_null($paymt_purpose)) {
            array_push($this->openAPINullablesSetToNull, 'paymt_purpose');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('paymt_purpose', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $payee_payer_name Name of the other party
     *
     * @return self
     */
     ...
     *
     * @param string|null $payee_payer_acct_no IBAN or account number of the other party
     *
     * @return self
     */
    public function setPayeePayerAcctNo($payee_payer_acct_no)
    {
        if (is_null($payee_payer_acct_no)) {
            array_push($this->openAPINullablesSetToNull, 'payee_payer_acct_no');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payee_payer_acct_no', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $payee_payer_bank_code BIC or bank code of the other party
     *
     * @return self
     */
    public function setPayeePayerBankCode($payee_payer_bank_code)
    {
        if (is_null($payee_payer_bank_code)) {
            array_push($this->openAPINullablesSetToNull, 'payee_payer_bank_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payee_payer_bank_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
