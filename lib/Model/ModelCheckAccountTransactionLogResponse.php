...
class ModelCheckAccountTransactionLogResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'object_name' => 'string',
        'sev_client' => '\Itsmind\Sevdesk\Model\ModelCheckAccountTransactionLogResponseSevClient',
        'to_status' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'CheckAccountTransactionLog');
    ...
    */
     ...
     * Gets sev_client
     *
     * @return \Itsmind\Sevdesk\Model\ModelCheckAccountTransactionLogResponseSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \Itsmind\Sevdesk\Model\ModelCheckAccountTransactionLogResponseSevClient|null $sev_client sev_client
     *
     * @return self
     */
