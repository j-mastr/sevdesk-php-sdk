 ...
 */
class ModelContactAddressResponseCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactAddressResponse_category';
    ...
    public const OBJECT_NAME_CATEGORY = 'Category';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'Category');
    }
