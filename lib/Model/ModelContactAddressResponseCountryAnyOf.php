<?php
/**
 * ModelContactAddressResponseCountryAnyOf
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ModelContactAddressResponseCountryAnyOf Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelContactAddressResponseCountryAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactAddressResponse_country_anyOf';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'StaticCountry');
    }
