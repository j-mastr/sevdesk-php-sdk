 ...
 */
class ModelContactAddressResponseSevClient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactAddressResponse_sevClient';
