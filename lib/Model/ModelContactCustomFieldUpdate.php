...
class ModelContactCustomFieldUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'contact_custom_field_setting' => '\Itsmind\Sevdesk\Model\ModelContactCustomFieldUpdateContactCustomFieldSetting',
        'value' => 'string',
        'object_name' => 'string'
    ];
    ...
    public const OBJECT_NAME_CONTACT_CUSTOM_FIELD = 'ContactCustomField';
    ...
    {
        return [
            self::OBJECT_NAME_CONTACT_CUSTOM_FIELD,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'ContactCustomField');
    }
    ...
    */
     ...
     *
     * @return \Itsmind\Sevdesk\Model\ModelContactCustomFieldUpdateContactCustomFieldSetting|null
     */
     ...
     *
     * @param \Itsmind\Sevdesk\Model\ModelContactCustomFieldUpdateContactCustomFieldSetting|null $contact_custom_field_setting contact_custom_field_setting
     *
     * @return self
     */
