<?php
/**
 * ModelContactCustomFieldUpdateContactCustomFieldSetting
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ModelContactCustomFieldUpdateContactCustomFieldSetting Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelContactCustomFieldUpdateContactCustomFieldSetting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactCustomFieldUpdate_contactCustomFieldSetting';
    ...
    public const OBJECT_NAME_CONTACT_CUSTOM_FIELD_SETTING = 'ContactCustomFieldSetting';
    ...
    {
        return [
            self::OBJECT_NAME_CONTACT_CUSTOM_FIELD_SETTING,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'ContactCustomFieldSetting');
    }
