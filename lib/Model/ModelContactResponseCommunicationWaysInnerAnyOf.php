<?php
/**
 * ModelContactResponseCommunicationWaysInnerAnyOf
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ModelContactResponseCommunicationWaysInnerAnyOf Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class ModelContactResponseCommunicationWaysInnerAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactResponse_communicationWays_inner_anyOf';
    ...
    public const OBJECT_NAME_COMMUNICATION_WAY = 'CommunicationWay';
    ...
    {
        return [
            self::OBJECT_NAME_COMMUNICATION_WAY,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'CommunicationWay');
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the communication way
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'CommunicationWay'
     *
     * @return self
     */
