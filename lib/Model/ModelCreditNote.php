...
class ModelCreditNote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['address_country'] === null && !$this->isNullableSetToNull('address_country')) {
            $invalidProperties[] = "'address_country' is required";
        }
     ...
     * Sets status
     *
     * @param string $status Please have a look in       <a href='#tag/CreditNote/Status-of-credit-notes'>status of credit note</a>      to see what the different status codes mean
     *
     * @return self
     */
     ...
     * Sets tax_type
     *
     * @param string $tax_type **Use this in sevdesk-Update 1.0 (instead of taxRule).**  Tax type of the creditNote. There are four tax types: 1. default - Umsatzsteuer ausweisen 2. eu - Steuerfreie innergemeinschaftliche Lieferung (Europäische Union) 3. noteu - Steuerschuldnerschaft des Leistungsempfängers (außerhalb EU, z. B. Schweiz) 4. custom - Using custom tax set 5. ss - Not subject to VAT according to §19 1 UStG Tax rates are heavily connected to the tax type used.
     *
     * @return self
     */
     ...
     *
     * @param string|null $booking_category Defines the booking category, for more information see the section [Credit note booking categories](#tag/CreditNote/Credit-note-booking-categories)  The booking category of the credit note.  **<code>ACCOUNTING_TYPE</code> is currently not supported in sevdesk-Update 2.0.**
     *
     * @return self
     */
