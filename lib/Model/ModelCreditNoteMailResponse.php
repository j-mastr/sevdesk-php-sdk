 ...
 */
class ModelCreditNoteMailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_creditNote_mailResponse';
    ...
    protected static $openAPITypes = [
        ...
        'create' => '\DateTime',
        'update' => '\DateTime',
        'object' => '\Itsmind\Sevdesk\Model\ModelCreditNoteResponse',
        'from' => 'string',
        'to' => 'string',
        'subject' => 'string',
        'text' => 'string',
        'sev_client' => '\Itsmind\Sevdesk\Model\ModelCreditNoteMailResponseSevClient'
    ];
    ...
    */
     ...
     * Sets object_name
     *
     * @param string|null $object_name Model name, which is 'Email'
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \DateTime|null $update Date of last email update
     *
     * @return self
     */
     ...
     * Sets object
     *
     * @param \Itsmind\Sevdesk\Model\ModelCreditNoteResponse|null $object object
     *
     * @return self
     */
     ...
     * Gets sev_client
     *
     * @return \Itsmind\Sevdesk\Model\ModelCreditNoteMailResponseSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \Itsmind\Sevdesk\Model\ModelCreditNoteMailResponseSevClient|null $sev_client sev_client
     *
     * @return self
     */
