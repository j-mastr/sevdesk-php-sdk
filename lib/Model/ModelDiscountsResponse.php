 ...
 */
class ModelDiscountsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_discountsResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The id of the discount
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param string|null $create Date of discount creation
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param string|null $update Date of last discount update
     *
     * @return self
     */
     ...
     * Sets sev_client
     *
     * @param string|null $sev_client Client to which the discount belongs
     *
     * @return self
     */
     ...
     * Sets discount
     *
     * @param string|null $discount Indicates that this is a discount or a surcharge (0 = surcharge, 1 = discount)
     *
     * @return self
     */
     ...
     * Sets is_net
     *
     * @param string|null $is_net Defines is the Discount net or gross (0 = net, 1 = gross)
     *
     * @return self
     */
