...
class ModelInvoiceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets invoice_date
     *
     * @param \DateTime|null $invoice_date Needs to be provided as timestamp or dd.mm.yyyy  **Requirements:** * For final invoices (invoiceType = 'ER'), the invoiceDate must be later than or equal to the invoiceDate of related advance (invoiceType = 'AR') / partial (invoiceType = 'TR') invoices.</li>
     *
     * @return self
     */
