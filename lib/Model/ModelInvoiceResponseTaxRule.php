...
/**
 * ModelInvoiceResponseTaxRule Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelInvoiceResponseTaxRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_InvoiceResponse_taxRule';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'TaxRule');
    }
