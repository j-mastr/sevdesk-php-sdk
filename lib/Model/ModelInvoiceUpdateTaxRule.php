...
/**
 * ModelInvoiceUpdateTaxRule Class Doc Comment
 *
 * @category Class
 * @description **Use this in sevdesk-Update 2.0 (replaces taxType / taxSet).**  See [list of available VAT rules](#section/sevdesk-Update-2.0/Tax-Rules).
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ModelInvoiceUpdateTaxRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_InvoiceUpdate_taxRule';
    ...
    public const OBJECT_NAME_TAX_RULE = 'TaxRule';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string $object_name Name of the object. Must always be TaxRule
     *
     * @return self
     */
