...
class ModelOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets status
     *
     * @param int $status Please have a look in       <a href='#tag/Order/Types-and-status-of-orders'>status of orders</a>      to see what the different status codes mean
     *
     * @return self
     */
     ...
     * Gets tax_rule
     *
     * @return \Itsmind\Sevdesk\Model\ModelOrderResponseTaxRule
     */
     ...
     * Sets tax_rule
     *
     * @param \Itsmind\Sevdesk\Model\ModelOrderResponseTaxRule $tax_rule tax_rule
     *
     * @return self
     */
     ...
     * Sets tax_type
     *
     * @param string $tax_type **Use this in sevdesk-Update 1.0 (instead of taxRule).**  Tax type of the order. There are four tax types: 1. default - Umsatzsteuer ausweisen 2. eu - Steuerfreie innergemeinschaftliche Lieferung (Europäische Union) 3. noteu - Steuerschuldnerschaft des Leistungsempfängers (außerhalb EU, z. B. Schweiz) 4. custom - Using custom tax set 5. ss - Not subject to VAT according to §19 1 UStG Tax rates are heavily connected to the tax type used.
     *
     * @return self
     */
