...
class ModelOrderPosResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'part' => '\Itsmind\Sevdesk\Model\ModelOrderPosResponsePart',
        'quantity' => 'string',
        'price' => 'string',
        'price_net' => 'string',
        'price_tax' => 'string',
        'price_gross' => 'string',
        'name' => 'string',
        'unity' => '\Itsmind\Sevdesk\Model\ModelOrderPosResponseUnity',
    ...
    public const OBJECT_NAME_ORDER_POS = 'OrderPos';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'OrderPos');
    ...
    */
     ...
     * Gets part
     *
     * @return \Itsmind\Sevdesk\Model\ModelOrderPosResponsePart|null
     */
     ...
     * Sets part
     *
     * @param \Itsmind\Sevdesk\Model\ModelOrderPosResponsePart|null $part part
     *
     * @return self
     */
     ...
     * Gets unity
     *
     * @return \Itsmind\Sevdesk\Model\ModelOrderPosResponseUnity|null
     */
     ...
     * Sets unity
     *
     * @param \Itsmind\Sevdesk\Model\ModelOrderPosResponseUnity|null $unity unity
     *
     * @return self
     */
