...
/**
 * ModelOrderPosResponseUnity Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelOrderPosResponseUnity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_OrderPosResponse_unity';
    ...
    public const OBJECT_NAME_UNITY = 'Unity';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'Unity');
    }
