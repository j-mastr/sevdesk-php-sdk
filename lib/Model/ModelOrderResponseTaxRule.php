...
/**
 * ModelOrderResponseTaxRule Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelOrderResponseTaxRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_OrderResponse_taxRule';
