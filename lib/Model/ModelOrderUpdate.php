...
class ModelOrderUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'origin' => '\Itsmind\Sevdesk\Model\ModelOrderUpdateOrigin',
        'version' => 'int',
        'small_settlement' => 'bool',
        'contact_person' => '\Itsmind\Sevdesk\Model\ModelOrderUpdateContactPerson',
        'tax_rate' => 'float',
        'tax_rule' => '\Itsmind\Sevdesk\Model\ModelOrderResponseTaxRule',
    ...
    public const STATUS_NUMBER_300 = 300;
    public const STATUS_NUMBER_500 = 500;
    public const STATUS_NUMBER_750 = 750;
    ...
    public function getStatusAllowableValues()
    {
        return [
            ...
            self::STATUS_NUMBER_300,
            self::STATUS_NUMBER_500,
            self::STATUS_NUMBER_750,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'Order');
    ...
    */
     ...
     * Sets status
     *
     * @param int|null $status Please have a look in       <a href='#tag/Order/Types-and-status-of-orders'>status of orders</a>      to see what the different status codes mean
     *
     * @return self
     */
     ...
     * Gets origin
     *
     * @return \Itsmind\Sevdesk\Model\ModelOrderUpdateOrigin|null
     */
     ...
     * Sets origin
     *
     * @param \Itsmind\Sevdesk\Model\ModelOrderUpdateOrigin|null $origin origin
     *
     * @return self
     */
     ...
     * Gets tax_rule
     *
     * @return \Itsmind\Sevdesk\Model\ModelOrderResponseTaxRule|null
     */
     ...
     * Sets tax_rule
     *
     * @param \Itsmind\Sevdesk\Model\ModelOrderResponseTaxRule|null $tax_rule tax_rule
     *
     * @return self
     */
     ...
     * Sets tax_type
     *
     * @param string|null $tax_type **Use this in sevdesk-Update 1.0 (instead of taxRule).**  Tax type of the order. There are four tax types: 1. default - Umsatzsteuer ausweisen 2. eu - Steuerfreie innergemeinschaftliche Lieferung (Europäische Union) 3. noteu - Steuerschuldnerschaft des Leistungsempfängers (außerhalb EU, z. B. Schweiz) 4. custom - Using custom tax set 5. ss - Not subject to VAT according to §19 1 UStG Tax rates are heavily connected to the tax type used.
     *
     * @return self
     */
     ...
     * Sets order_type
     *
     * @param string|null $order_type Type of the order. For more information on the different types, check      <a href='#tag/Order/Types-and-status-of-orders'>this</a>
     *
     * @return self
     */
