<?php
/**
 * ModelPrivateTransactionRuleResponse
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ModelPrivateTransactionRuleResponse Class Doc Comment
 *
 * @category Class
 * @description A rule defining which transactions to mark as private automatically.
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ModelPrivateTransactionRuleResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_PrivateTransactionRuleResponse';
    ...
    protected static $openAPITypes = [
        ...
        'create' => '\DateTime',
        'update' => '\DateTime',
        'sev_client' => '\Itsmind\Sevdesk\Model\ModelPrivateTransactionRuleResponseSevClient',
    ...
    */
     ...
     * Sets object_name
     *
     * @param string|null $object_name The entity object name, PrivateTransactionRule
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param \DateTime|null $create Date of entity creation
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \DateTime|null $update Date of last entity update
     *
     * @return self
     */
     ...
     * Gets sev_client
     *
     * @return \Itsmind\Sevdesk\Model\ModelPrivateTransactionRuleResponseSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \Itsmind\Sevdesk\Model\ModelPrivateTransactionRuleResponseSevClient|null $sev_client sev_client
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_purpose The payment purpose of transactions to match
     *
     * @return self
     */
    public function setPaymentPurpose($payment_purpose)
    {
        if (is_null($payment_purpose)) {
            array_push($this->openAPINullablesSetToNull, 'payment_purpose');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payment_purpose', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param string|null $counterpart_name The counterpart name of transactions to match
     *
     * @return self
     */
