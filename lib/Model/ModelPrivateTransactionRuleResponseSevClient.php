...
/**
 * ModelPrivateTransactionRuleResponseSevClient Class Doc Comment
 *
 * @category Class
 * @description Client to which the entity belongs.
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ModelPrivateTransactionRuleResponseSevClient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_PrivateTransactionRuleResponse_sevClient';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier of the client
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string|null $object_name Model name, which is 'SevClient'
     *
     * @return self
     */
