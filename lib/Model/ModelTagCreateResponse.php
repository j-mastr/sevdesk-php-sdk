...
class ModelTagCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sev_client' => '\Itsmind\Sevdesk\Model\ModelTagResponseSevClient'
    ];
    ...
    public const OBJECT_NAME_TAG_RELATION = 'TagRelation';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'TagRelation');
    ...
    */
     ...
     * Sets object_name
     *
     * @param string|null $object_name Internal object name which is 'TagRelation'.
     *
     * @return self
     */
     ...
     * Gets sev_client
     *
     * @return \Itsmind\Sevdesk\Model\ModelTagResponseSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \Itsmind\Sevdesk\Model\ModelTagResponseSevClient|null $sev_client sev_client
     *
     * @return self
     */
