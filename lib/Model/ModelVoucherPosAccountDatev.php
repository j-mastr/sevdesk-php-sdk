...
/**
 * ModelVoucherPosAccountDatev Class Doc Comment
 *
 * @category Class
 * @description &lt;b&gt;Use this in sevdesk-Update 2.0 (replaces accountingType).&lt;/b&gt;       The account datev to which the position belongs.&lt;br&gt;       An account datev is the booking account to which the position belongs.&lt;br&gt;       For more information, please refer to   &lt;a href&#x3D;&#39;#tag/Voucher/Account-Datev&#39;&gt;this&lt;/a&gt; section.
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ModelVoucherPosAccountDatev implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_VoucherPos_accountDatev';
    ...
    public const OBJECT_NAME_ACCOUNT_DATEV = 'AccountDatev';
    ...
    {
        return [
            self::OBJECT_NAME_ACCOUNT_DATEV,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'AccountDatev');
    }
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Unique identifier of the account datev
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'AccountDatev'
     *
     * @return self
     */
