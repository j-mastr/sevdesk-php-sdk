...
class ModelVoucherPosResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'account_datev' => '\Itsmind\Sevdesk\Model\ModelVoucherPosResponseAccountDatev',
    ...
    public const OBJECT_NAME_VOUCHER_POS = 'VoucherPos';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'VoucherPos');
        ...
        $this->setIfExists('account_datev', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['account_datev'] === null) {
            $invalidProperties[] = "'account_datev' can't be null";
        }
     ...
     * Gets account_datev
     *
     * @return \Itsmind\Sevdesk\Model\ModelVoucherPosResponseAccountDatev
     */
    public function getAccountDatev()
    {
        return $this->container['account_datev'];
    }

    /**
     * Sets account_datev
     *
     * @param \Itsmind\Sevdesk\Model\ModelVoucherPosResponseAccountDatev $account_datev account_datev
     *
     * @return self
     */
    public function setAccountDatev($account_datev)
    {
        if (is_null($account_datev)) {
            throw new \InvalidArgumentException('non-nullable account_datev cannot be null');
        }
        $this->container['account_datev'] = $account_datev;
