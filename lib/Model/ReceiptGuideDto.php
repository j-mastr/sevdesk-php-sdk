...
/**
 * ReceiptGuideDto Class Doc Comment
 *
 * @category Class
 ...
 */
class ReceiptGuideDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceiptGuideDto';
    ...
    protected static $openAPITypes = [
        'account_datev_id' => 'int',
        'account_number' => 'string',
        'account_name' => 'string',
        'description' => 'string',
        'allowed_tax_rules' => '\Itsmind\Sevdesk\Model\ReceiptGuideDtoAllowedTaxRulesInner[]',
        'allowed_receipt_types' => 'string[]'
    ];
    ...
    protected static array $openAPINullables = [
        'account_datev_id' => false,
        'account_number' => false,
        'account_name' => false,
        'description' => false,
        'allowed_tax_rules' => false,
        'allowed_receipt_types' => false
    ];
    ...
    protected static $setters = [
        'account_datev_id' => 'setAccountDatevId',
        'account_number' => 'setAccountNumber',
        'account_name' => 'setAccountName',
        'description' => 'setDescription',
        'allowed_tax_rules' => 'setAllowedTaxRules',
        'allowed_receipt_types' => 'setAllowedReceiptTypes'
    ];
    ...
    protected static $getters = [
        'account_datev_id' => 'getAccountDatevId',
        'account_number' => 'getAccountNumber',
        'account_name' => 'getAccountName',
        'description' => 'getDescription',
        'allowed_tax_rules' => 'getAllowedTaxRules',
        'allowed_receipt_types' => 'getAllowedReceiptTypes'
    ];
    ...
    {
        $this->setIfExists('account_datev_id', $data ?? [], null);
        $this->setIfExists('account_number', $data ?? [], null);
        $this->setIfExists('account_name', $data ?? [], null);
        $this->setIfExists('description', $data ?? [], null);
        $this->setIfExists('allowed_tax_rules', $data ?? [], null);
        $this->setIfExists('allowed_receipt_types', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets account_datev_id
     *
     * @return int|null
     */
    public function getAccountDatevId()
    {
        return $this->container['account_datev_id'];
    }

    /**
     * Sets account_datev_id
     *
     * @param int|null $account_datev_id The ID of the matching account datev
     *
     * @return self
     */
    public function setAccountDatevId($account_datev_id)
    {
        if (is_null($account_datev_id)) {
            throw new \InvalidArgumentException('non-nullable account_datev_id cannot be null');
        }
        $this->container['account_datev_id'] = $account_datev_id;
     ...
     * Sets account_number
     *
     * @param string|null $account_number The account number of the account datev (dependent on the active accounting system of the client)
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description of the account and/or what the account is used for
     *
     * @return self
     */
    ...
    /**
     * Gets allowed_tax_rules
     *
     * @return \Itsmind\Sevdesk\Model\ReceiptGuideDtoAllowedTaxRulesInner[]|null
     */
    public function getAllowedTaxRules()
    {
        return $this->container['allowed_tax_rules'];
    }

    /**
     * Sets allowed_tax_rules
     *
     * @param \Itsmind\Sevdesk\Model\ReceiptGuideDtoAllowedTaxRulesInner[]|null $allowed_tax_rules An array that holds all possible tax rules for this account
     *
     * @return self
     */
    public function setAllowedTaxRules($allowed_tax_rules)
    {
        if (is_null($allowed_tax_rules)) {
            throw new \InvalidArgumentException('non-nullable allowed_tax_rules cannot be null');
        }
        $this->container['allowed_tax_rules'] = $allowed_tax_rules;

        return $this;
    }

    /**
     * Gets allowed_receipt_types
     *
     * @return string[]|null
     */
    public function getAllowedReceiptTypes()
    {
        return $this->container['allowed_receipt_types'];
    }

    /**
     * Sets allowed_receipt_types
     *
     * @param string[]|null $allowed_receipt_types An array that holds the viable receipt types for this account
     *
     * @return self
     */
    public function setAllowedReceiptTypes($allowed_receipt_types)
    {
        if (is_null($allowed_receipt_types)) {
            throw new \InvalidArgumentException('non-nullable allowed_receipt_types cannot be null');
        }
        $this->container['allowed_receipt_types'] = $allowed_receipt_types;
