...
/**
 * ReceiptGuideDtoAllowedTaxRulesInner Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class ReceiptGuideDtoAllowedTaxRulesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceiptGuideDto_allowedTaxRules_inner';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description A readable description of the tax rule
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int|null $id The id of the tax rule to use in different scenarios
     *
     * @return self
     */
     ...
     * Sets tax_rates
     *
     * @param string[]|null $tax_rates An array of tax rates which are combinable with this tax rule
     *
     * @return self
     */
