...
/**
 * SaveInvoiceDiscountSaveInner Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class SaveInvoiceDiscountSaveInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveInvoice_discountSave_inner';
    ...
    public const OBJECT_NAME_DISCOUNTS = 'Discounts';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_name', $data ?? [], 'Discounts');
    ...
    */
     ...
     * Sets discount
     *
     * @param bool|null $discount Defines if this is a discount or a surcharge
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text A text for your discount
     *
     * @return self
     */
     ...
     * Sets percentage
     *
     * @param bool|null $percentage Defines if this is a percentage or an absolute discount
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param float|null $value Value of the discount
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string|null $object_name Object name of the discount
     *
     * @return self
     */
     ...
     * Sets map_all
     *
     * @param bool|null $map_all Internal param
     *
     * @return self
     */
