...
/**
 * UpdateExportConfigRequest Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateExportConfigRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateExportConfig_request';
    ...
    protected static array $openAPINullables = [
        'accountant_number' => false,
        'accountant_client_number' => false,
        'accounting_year_begin' => false
    ];
    ...
    {
        $this->setIfExists('accountant_number', $data ?? [], null);
        $this->setIfExists('accountant_client_number', $data ?? [], null);
        $this->setIfExists('accounting_year_begin', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($accountant_number)) {
            throw new \InvalidArgumentException('non-nullable accountant_number cannot be null');
        }
    ...
    {
        if (is_null($accountant_client_number)) {
            throw new \InvalidArgumentException('non-nullable accountant_client_number cannot be null');
        }
    ...
    {
        if (is_null($accounting_year_begin)) {
            throw new \InvalidArgumentException('non-nullable accounting_year_begin cannot be null');
        }
