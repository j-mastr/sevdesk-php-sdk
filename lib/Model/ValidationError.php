...
class ValidationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'error' => '\Itsmind\Sevdesk\Model\ValidationErrorError'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \Itsmind\Sevdesk\Model\ValidationErrorError|null
     */
     ...
     * Sets error
     *
     * @param \Itsmind\Sevdesk\Model\ValidationErrorError|null $error error
     *
     * @return self
     */
