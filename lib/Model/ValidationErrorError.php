...
class ValidationErrorError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('exception_uuid', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets exception_uuid
     *
     * @param string|null $exception_uuid An identifier of this exact problem that can be given to the support team.
     *
     * @return self
     */
    public function setExceptionUuid($exception_uuid)
    {
        if (is_null($exception_uuid)) {
            throw new \InvalidArgumentException('non-nullable exception_uuid cannot be null');
        }
