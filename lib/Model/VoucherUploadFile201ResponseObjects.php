...
/**
 * VoucherUploadFile201ResponseObjects Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class VoucherUploadFile201ResponseObjects implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'voucherUploadFile_201_response_objects';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('origin_mime_type', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $origin_mime_type origin_mime_type
     *
     * @return self
     */
    public function setOriginMimeType($origin_mime_type)
    {
        if (is_null($origin_mime_type)) {
            throw new \InvalidArgumentException('non-nullable origin_mime_type cannot be null');
        }
